...
exports.ids = [762];
exports.modules = {
  /***/ 77709: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const core_1 = __webpack_require__(52563);
  ...
  /***/ 12547: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const ruleset_1 = __webpack_require__(14523);
  ...
  /***/ 14523: /***/ (__unused_webpack_module, exports) => {
    Object.defineProperty(exports, '__esModule', {value: true});
      ...
      rules: [
        {
          ...
          rules: [
            ...
            {
              rules: [
                {conditions: [m], error: 'Invalid Configuration: Dualstack and custom endpoint are not supported', type: d},
              ...
              rules: [
                {
                  ...
                  rules: [
                    {conditions: [{[v]: h, [w]: [o, 'aws']}, p, q], endpoint: {url: 'https://{Region}.signin.aws.amazon.com', properties: n, headers: n}, type: e},
                    {conditions: [{[v]: h, [w]: [o, 'aws-cn']}, p, q], endpoint: {url: 'https://{Region}.signin.amazonaws.cn', properties: n, headers: n}, type: e},
                    {conditions: [{[v]: h, [w]: [o, 'aws-us-gov']}, p, q], endpoint: {url: 'https://{Region}.signin.amazonaws-us-gov.com', properties: n, headers: n}, type: e},
                    {
                      conditions: [l, m],
                      rules: [
                        {
                          conditions: [{[v]: c, [w]: [a, r]}, s],
                          rules: [{endpoint: {url: 'https://signin-fips.{Region}.{PartitionResult#dualStackDnsSuffix}', properties: n, headers: n}, type: e}],
                          type: f
                        },
                      ...
                      rules: [
                        {
                          ...
                          rules: [{endpoint: {url: 'https://signin-fips.{Region}.{PartitionResult#dnsSuffix}', properties: n, headers: n}, type: e}],
                          type: f
                        },
                    ...
                    },
                    {
                      conditions: [p, m],
                      rules: [
                        {conditions: [s], rules: [{endpoint: {url: 'https://signin.{Region}.{PartitionResult#dualStackDnsSuffix}', properties: n, headers: n}, type: e}], type: f},
                        {error: 'DualStack is enabled but this partition does not support DualStack', type: d}
                      ],
                      type: f
                    },
                    {endpoint: {url: 'https://signin.{Region}.{PartitionResult#dnsSuffix}', properties: n, headers: n}, type: e}
                  ],
                  type: f
                }
              ],
  ...
  /***/ 99762: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    var smithyClient = __webpack_require__(83792);
    ...
    const resolveRuntimeExtensions = (runtimeConfig, extensions) => {
      ...
      return Object.assign(
        runtimeConfig,
        regionConfigResolver.resolveAwsRegionExtensionConfiguration(extensionConfiguration),
    ...
    var CreateOAuth2TokenRequest$ = [3, n0, _COATR, 0, [_tI], [[() => CreateOAuth2TokenRequestBody$, 16]], 1];
    ...
    var CreateOAuth2TokenResponse$ = [3, n0, _COATRr, 0, [_tO], [[() => CreateOAuth2TokenResponseBody$, 16]], 1];
    ...
    var CreateOAuth2Token$ = [9, n0, _COAT, {[_h]: ['POST', '/v1/token', 200]}, () => CreateOAuth2TokenRequest$, () => CreateOAuth2TokenResponse$];
  ...
  /***/ 22836: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    Object.defineProperty(exports, '__esModule', {value: true});
    ...
    const smithy_client_1 = __webpack_require__(83792);
  ...
  /***/ 357: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    Object.defineProperty(exports, '__esModule', {value: true});
    exports.getRuntimeConfig = void 0;
    const core_1 = __webpack_require__(52563);
    const protocols_1 = __webpack_require__(11381);
