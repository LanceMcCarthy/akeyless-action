...
export function fetchAndValidateInput() {
    const params = {
    ...
    if (typeof params.exportSecretsToOutputs !== 'boolean')
        params.exportSecretsToOutputs = true;
    if (typeof params.exportSecretsToEnvironment !== 'boolean')
        params.exportSecretsToEnvironment = true;
    if (typeof params.parseDynamicSecrets !== 'boolean')
        params.parseDynamicSecrets = false;
