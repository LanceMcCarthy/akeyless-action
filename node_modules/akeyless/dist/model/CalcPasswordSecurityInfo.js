 ...
 * @version 5.0.14
 */
var CalcPasswordSecurityInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CalcPasswordSecurityInfo</code>.
   * @alias module:model/CalcPasswordSecurityInfo
   */
  function CalcPasswordSecurityInfo() {
    _classCallCheck(this, CalcPasswordSecurityInfo);
  ...
  _createClass(CalcPasswordSecurityInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('min_length')) {
          obj['min_length'] = _ApiClient["default"].convertToType(data['min_length'], 'Number');
        }
...
var _default = CalcPasswordSecurityInfo;
