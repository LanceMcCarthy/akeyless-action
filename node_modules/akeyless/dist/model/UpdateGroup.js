...
var UpdateGroup = /*#__PURE__*/function () {
   ...
   */
  function UpdateGroup(groupAlias, name) {
  ...
  _createClass(UpdateGroup, null, [{
    key: "initialize",
    value: function initialize(obj, groupAlias, name) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('group-alias')) {
          obj['group-alias'] = _ApiClient["default"].convertToType(data['group-alias'], 'String');
        }
        ...
        if (data.hasOwnProperty('user-assignment')) {
          obj['user-assignment'] = _ApiClient["default"].convertToType(data['user-assignment'], 'String');
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateGroup.RequiredProperties),
          _step;
