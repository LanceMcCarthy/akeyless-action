 ...
 * @version 5.0.14
 */
var PasswordExpirationInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PasswordExpirationInfo</code>.
   * @alias module:model/PasswordExpirationInfo
   */
  function PasswordExpirationInfo() {
    _classCallCheck(this, PasswordExpirationInfo);
  ...
  _createClass(PasswordExpirationInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('days_before_expire')) {
          obj['days_before_expire'] = _ApiClient["default"].convertToType(data['days_before_expire'], 'Number');
        }

        if (data.hasOwnProperty('days_before_notification')) {
          obj['days_before_notification'] = _ApiClient["default"].convertToType(data['days_before_notification'], 'Number');
        }

        if (data.hasOwnProperty('days_until_expire')) {
          obj['days_until_expire'] = _ApiClient["default"].convertToType(data['days_until_expire'], 'Number');
        }
...
var _default = PasswordExpirationInfo;
