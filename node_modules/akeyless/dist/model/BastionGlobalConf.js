 ...
 * @version 5.0.16
 */
var BastionGlobalConf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BastionGlobalConf</code>.
   * @alias module:model/BastionGlobalConf
   */
  function BastionGlobalConf() {
    _classCallCheck(this, BastionGlobalConf);
  ...
  _createClass(BastionGlobalConf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_bastion_urls')) {
          obj['allowed_bastion_urls'] = _ApiClient["default"].convertToType(data['allowed_bastion_urls'], ['String']);
        }

        if (data.hasOwnProperty('allowed_ssh_url')) {
          obj['allowed_ssh_url'] = _ApiClient["default"].convertToType(data['allowed_ssh_url'], 'String');
        }

        if (data.hasOwnProperty('default_session_ttl_minutes')) {
          obj['default_session_ttl_minutes'] = _ApiClient["default"].convertToType(data['default_session_ttl_minutes'], 'Number');
        }

        if (data.hasOwnProperty('legacy_signing_alg')) {
          obj['legacy_signing_alg'] = _ApiClient["default"].convertToType(data['legacy_signing_alg'], 'Boolean');
        }

        if (data.hasOwnProperty('rdp_username_sub_claim')) {
          obj['rdp_username_sub_claim'] = _ApiClient["default"].convertToType(data['rdp_username_sub_claim'], 'String');
        }

        if (data.hasOwnProperty('ssh_username_sub_claim')) {
          obj['ssh_username_sub_claim'] = _ApiClient["default"].convertToType(data['ssh_username_sub_claim'], 'String');
        }
      }
...
var _default = BastionGlobalConf;
