    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed-ssh-url')) {
          obj['allowed-ssh-url'] = _ApiClient["default"].convertToType(data['allowed-ssh-url'], 'String');
        }
        ...
        if (data.hasOwnProperty('default-session-ttl-minutes')) {
          obj['default-session-ttl-minutes'] = _ApiClient["default"].convertToType(data['default-session-ttl-minutes'], 'String');
        }
