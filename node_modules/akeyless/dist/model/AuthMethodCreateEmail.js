 ...
 * @version 5.0.16
 */
var AuthMethodCreateEmail = /*#__PURE__*/function () {
  /**
   ...
   */
  function AuthMethodCreateEmail(email, name) {
    _classCallCheck(this, AuthMethodCreateEmail);
  ...
  _createClass(AuthMethodCreateEmail, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('enable-mfa')) {
          obj['enable-mfa'] = _ApiClient["default"].convertToType(data['enable-mfa'], 'String');
        }
        ...
        if (data.hasOwnProperty('mfa-type')) {
          obj['mfa-type'] = _ApiClient["default"].convertToType(data['mfa-type'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodCreateEmail.RequiredProperties),
          _step;
...
var _default = AuthMethodCreateEmail;
