...
var _SshBastionSessionTermination = _interopRequireDefault(require("./SshBastionSessionTermination"));
 ...
 * @version 5.0.14
 */
var SshBastionConf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SshBastionConf</code>.
   * @alias module:model/SshBastionConf
   */
  function SshBastionConf() {
    _classCallCheck(this, SshBastionConf);
  ...
  _createClass(SshBastionConf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('hide_session_recording')) {
          obj['hide_session_recording'] = _ApiClient["default"].convertToType(data['hide_session_recording'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('session_termination')) {
          obj['session_termination'] = _SshBastionSessionTermination["default"].constructFromObject(data['session_termination']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['session_termination']) {
        // data not null
        _SshBastionSessionTermination["default"].validateJSON(data['session_termination']);
      }
