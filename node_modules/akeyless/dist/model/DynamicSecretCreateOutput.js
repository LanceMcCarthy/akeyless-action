 ...
 * @version 5.0.6
 */
var DynamicSecretCreateOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DynamicSecretCreateOutput</code>.
   * @alias module:model/DynamicSecretCreateOutput
   */
  function DynamicSecretCreateOutput() {
    _classCallCheck(this, DynamicSecretCreateOutput);
  ...
  _createClass(DynamicSecretCreateOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('dynamic_secret_details')) {
          obj['dynamic_secret_details'] = _DSProducerDetails["default"].constructFromObject(data['dynamic_secret_details']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['dynamic_secret_details']) {
        // data not null
        _DSProducerDetails["default"].validateJSON(data['dynamic_secret_details']);
      }
...
var _default = DynamicSecretCreateOutput;
