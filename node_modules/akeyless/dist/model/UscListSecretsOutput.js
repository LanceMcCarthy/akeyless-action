 ...
 * @version 5.0.5
 */
var UscListSecretsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UscListSecretsOutput</code>.
   * @alias module:model/UscListSecretsOutput
   */
  function UscListSecretsOutput() {
    _classCallCheck(this, UscListSecretsOutput);
  ...
  _createClass(UscListSecretsOutput, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      if (data['secrets_list']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['secrets_list']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _SecretInfo["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = UscListSecretsOutput;
