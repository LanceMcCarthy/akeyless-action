 ...
 * @version 5.0.6
 */
var EventForwarderUpdateWebhook = /*#__PURE__*/function () {
  /**
   ...
   */
  function EventForwarderUpdateWebhook(gatewaysEventSourceLocations, name) {
    _classCallCheck(this, EventForwarderUpdateWebhook);
  ...
  _createClass(EventForwarderUpdateWebhook, null, [{
    key: "initialize",
    value: function initialize(obj, gatewaysEventSourceLocations, name) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('auth-token')) {
          obj['auth-token'] = _ApiClient["default"].convertToType(data['auth-token'], 'String');
        }
        ...
        if (data.hasOwnProperty('client-cert-data')) {
          obj['client-cert-data'] = _ApiClient["default"].convertToType(data['client-cert-data'], 'String');
        }
        ...
        if (data.hasOwnProperty('private-key-data')) {
          obj['private-key-data'] = _ApiClient["default"].convertToType(data['private-key-data'], 'String');
        }

        if (data.hasOwnProperty('server-certificates')) {
          obj['server-certificates'] = _ApiClient["default"].convertToType(data['server-certificates'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EventForwarderUpdateWebhook.RequiredProperties),
          _step;
...
var _default = EventForwarderUpdateWebhook;
