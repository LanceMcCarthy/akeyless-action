 ...
 * @version 5.0.1
 */
var GenerateCAOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GenerateCAOutput</code>.
   * @alias module:model/GenerateCAOutput
   */
  function GenerateCAOutput() {
    _classCallCheck(this, GenerateCAOutput);
  ...
  _createClass(GenerateCAOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('intermediate_certificate_name')) {
          obj['intermediate_certificate_name'] = _ApiClient["default"].convertToType(data['intermediate_certificate_name'], 'String');
        }

        if (data.hasOwnProperty('intermediate_issuer_name')) {
          obj['intermediate_issuer_name'] = _ApiClient["default"].convertToType(data['intermediate_issuer_name'], 'String');
        }

        if (data.hasOwnProperty('intermediate_key_name')) {
          obj['intermediate_key_name'] = _ApiClient["default"].convertToType(data['intermediate_key_name'], 'String');
        }

        if (data.hasOwnProperty('root_certificate_name')) {
          obj['root_certificate_name'] = _ApiClient["default"].convertToType(data['root_certificate_name'], 'String');
        }

        if (data.hasOwnProperty('root_issuer_name')) {
          obj['root_issuer_name'] = _ApiClient["default"].convertToType(data['root_issuer_name'], 'String');
        }

        if (data.hasOwnProperty('root_key_name')) {
          obj['root_key_name'] = _ApiClient["default"].convertToType(data['root_key_name'], 'String');
        }
      }
