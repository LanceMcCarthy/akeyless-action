...
var AzureStorage = /*#__PURE__*/function () {
  ...
  function AzureStorage() {
    _classCallCheck(this, AzureStorage);
  ...
  _createClass(AzureStorage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('storage_account')) {
          obj['storage_account'] = _ApiClient["default"].convertToType(data['storage_account'], 'String');
        }

        if (data.hasOwnProperty('storage_container_name')) {
          obj['storage_container_name'] = _ApiClient["default"].convertToType(data['storage_container_name'], 'String');
        }
