...
var AssocTargetItem = /*#__PURE__*/function () {
  ...
  _createClass(AssocTargetItem, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('external-key-name')) {
          obj['external-key-name'] = _ApiClient["default"].convertToType(data['external-key-name'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AssocTargetItem.RequiredProperties),
          _step;
