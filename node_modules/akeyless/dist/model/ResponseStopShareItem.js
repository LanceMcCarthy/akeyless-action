...
var _EmailError = _interopRequireDefault(require("./EmailError"));
 ...
 * @version 5.0.0
 */
var ResponseStopShareItem = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ResponseStopShareItem</code>.
   * @alias module:model/ResponseStopShareItem
   */
  function ResponseStopShareItem() {
    _classCallCheck(this, ResponseStopShareItem);
  ...
  _createClass(ResponseStopShareItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('errors')) {
          obj['errors'] = _ApiClient["default"].convertToType(data['errors'], [_EmailError["default"]]);
        }
      ...
      if (data['errors']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _EmailError["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = ResponseStopShareItem;
