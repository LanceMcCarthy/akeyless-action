 ...
 * @version 3.5.1
 */
var AccessOrGroupPermissionAssignment = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AccessOrGroupPermissionAssignment</code>.
   * @alias module:model/AccessOrGroupPermissionAssignment
   */
  function AccessOrGroupPermissionAssignment() {
    _classCallCheck(this, AccessOrGroupPermissionAssignment);
  ...
  _createClass(AccessOrGroupPermissionAssignment, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('assignment_name')) {
          obj['assignment_name'] = _ApiClient["default"].convertToType(data['assignment_name'], 'String');
        }
...
var _default = AccessOrGroupPermissionAssignment;
