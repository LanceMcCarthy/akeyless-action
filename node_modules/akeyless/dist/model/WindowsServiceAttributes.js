 ...
 * @version 5.0.16
 */
var WindowsServiceAttributes = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WindowsServiceAttributes</code>.
   * @alias module:model/WindowsServiceAttributes
   */
  function WindowsServiceAttributes() {
    _classCallCheck(this, WindowsServiceAttributes);
  ...
  _createClass(WindowsServiceAttributes, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('iis_app_pool')) {
          obj['iis_app_pool'] = _ApiClient["default"].convertToType(data['iis_app_pool'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('skip_restart')) {
          obj['skip_restart'] = _ApiClient["default"].convertToType(data['skip_restart'], 'Boolean');
        }
...
var _default = WindowsServiceAttributes;
