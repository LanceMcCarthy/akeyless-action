...
var _BastionGlobalConf = _interopRequireDefault(require("./BastionGlobalConf"));

var _SraDesktopAppConf = _interopRequireDefault(require("./SraDesktopAppConf"));

var _SshBastionConf = _interopRequireDefault(require("./SshBastionConf"));

var _WebBastionConf = _interopRequireDefault(require("./WebBastionConf"));
 ...
 * @version 5.0.14
 */
var BastionConfigReplyObj = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BastionConfigReplyObj</code>.
   * @alias module:model/BastionConfigReplyObj
   */
  function BastionConfigReplyObj() {
    _classCallCheck(this, BastionConfigReplyObj);
  ...
  _createClass(BastionConfigReplyObj, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('desktop_app')) {
          obj['desktop_app'] = _SraDesktopAppConf["default"].constructFromObject(data['desktop_app']);
        }

        if (data.hasOwnProperty('gator_cluster_id')) {
          obj['gator_cluster_id'] = _ApiClient["default"].convertToType(data['gator_cluster_id'], 'Number');
        }

        if (data.hasOwnProperty('global')) {
          obj['global'] = _BastionGlobalConf["default"].constructFromObject(data['global']);
        }

        if (data.hasOwnProperty('ssh_bastion')) {
          obj['ssh_bastion'] = _SshBastionConf["default"].constructFromObject(data['ssh_bastion']);
        }

        if (data.hasOwnProperty('web_bastion')) {
          obj['web_bastion'] = _WebBastionConf["default"].constructFromObject(data['web_bastion']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['desktop_app']) {
        // data not null
        _SraDesktopAppConf["default"].validateJSON(data['desktop_app']);
      } // validate the optional field `global`


      if (data['global']) {
        // data not null
        _BastionGlobalConf["default"].validateJSON(data['global']);
      } // validate the optional field `ssh_bastion`


      if (data['ssh_bastion']) {
        // data not null
        _SshBastionConf["default"].validateJSON(data['ssh_bastion']);
      } // validate the optional field `web_bastion`


      if (data['web_bastion']) {
        // data not null
        _WebBastionConf["default"].validateJSON(data['web_bastion']);
      }
...
var _default = BastionConfigReplyObj;
