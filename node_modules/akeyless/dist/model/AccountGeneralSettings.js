...
var _AiInsightsSetting = _interopRequireDefault(require("./AiInsightsSetting"));

var _AllowedClientType = _interopRequireDefault(require("./AllowedClientType"));

var _AllowedIpSettings = _interopRequireDefault(require("./AllowedIpSettings"));

var _CertificateExpirationEventsSettings = _interopRequireDefault(require("./CertificateExpirationEventsSettings"));

var _DataProtectionSection = _interopRequireDefault(require("./DataProtectionSection"));

var _DefaultHomePage = _interopRequireDefault(require("./DefaultHomePage"));
...
var AccountGeneralSettings = /*#__PURE__*/function () {
  ...
  _createClass(AccountGeneralSettings, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ai_insights')) {
          obj['ai_insights'] = _AiInsightsSetting["default"].constructFromObject(data['ai_insights']);
        }

        if (data.hasOwnProperty('allow_auto_fill')) {
          obj['allow_auto_fill'] = _ApiClient["default"].convertToType(data['allow_auto_fill'], 'Boolean');
        }

        if (data.hasOwnProperty('allowed_client_types')) {
          obj['allowed_client_types'] = _AllowedClientType["default"].constructFromObject(data['allowed_client_types']);
        }
        ...
        if (data.hasOwnProperty('certificate_expiration_events')) {
          obj['certificate_expiration_events'] = _CertificateExpirationEventsSettings["default"].constructFromObject(data['certificate_expiration_events']);
        }
        ...
        if (data.hasOwnProperty('default_home_page')) {
          obj['default_home_page'] = _DefaultHomePage["default"].constructFromObject(data['default_home_page']);
        }
        ...
        if (data.hasOwnProperty('hide_personal_folder')) {
          obj['hide_personal_folder'] = _ApiClient["default"].convertToType(data['hide_personal_folder'], 'Boolean');
        }

        if (data.hasOwnProperty('hide_static_password')) {
          obj['hide_static_password'] = _ApiClient["default"].convertToType(data['hide_static_password'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['ai_insights']) {
        // data not null
        _AiInsightsSetting["default"].validateJSON(data['ai_insights']);
      } // validate the optional field `allowed_client_types`


      if (data['allowed_client_types']) {
        // data not null
        _AllowedClientType["default"].validateJSON(data['allowed_client_types']);
      ...
      if (data['certificate_expiration_events']) {
        // data not null
        _CertificateExpirationEventsSettings["default"].validateJSON(data['certificate_expiration_events']);
      ...
      if (data['default_home_page']) {
        // data not null
        _DefaultHomePage["default"].validateJSON(data['default_home_page']);
