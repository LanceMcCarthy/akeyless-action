 ...
 * @version 5.0.3
 */
var AuthMethodGet = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AuthMethodGet</code>.
   * @alias module:model/AuthMethodGet
   * @param name {String} Auth Method name
   */
  function AuthMethodGet(name) {
    _classCallCheck(this, AuthMethodGet);
  ...
  _createClass(AuthMethodGet, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodGet.RequiredProperties),
          _step;
