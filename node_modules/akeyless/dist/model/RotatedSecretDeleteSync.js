 ...
 * @version 5.0.20
 */
var RotatedSecretDeleteSync = /*#__PURE__*/function () {
  /**
   ...
   */
  function RotatedSecretDeleteSync(name, uscName) {
    _classCallCheck(this, RotatedSecretDeleteSync);
  ...
  _createClass(RotatedSecretDeleteSync, null, [{
    key: "initialize",
    value: function initialize(obj, name, uscName) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('delete-from-usc')) {
          obj['delete-from-usc'] = _ApiClient["default"].convertToType(data['delete-from-usc'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('remote-secret-name')) {
          obj['remote-secret-name'] = _ApiClient["default"].convertToType(data['remote-secret-name'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretDeleteSync.RequiredProperties),
          _step;
...
var _default = RotatedSecretDeleteSync;
