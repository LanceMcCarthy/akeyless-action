...
var _ClientUsageInfo = _interopRequireDefault(require("./ClientUsageInfo"));
 ...
 * @version 5.0.3
 */
var ClientsUsageReport = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ClientsUsageReport</code>.
   * @alias module:model/ClientsUsageReport
   */
  function ClientsUsageReport() {
    _classCallCheck(this, ClientsUsageReport);
  ...
  _createClass(ClientsUsageReport, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('clients')) {
          obj['clients'] = _ApiClient["default"].convertToType(data['clients'], [_ClientUsageInfo["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['clients']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['clients']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ClientUsageInfo["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = ClientsUsageReport;
