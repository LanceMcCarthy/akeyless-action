 ...
 * @version 5.0.8
 */
var TargetUpdateLdap = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetUpdateLdap(bindDn, bindDnPassword, ldapUrl, name) {
    _classCallCheck(this, TargetUpdateLdap);
  ...
  _createClass(TargetUpdateLdap, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateLdap.RequiredProperties),
          _step;
