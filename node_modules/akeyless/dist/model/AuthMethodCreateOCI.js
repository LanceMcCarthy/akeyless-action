 ...
 * @version 5.0.20
 */
var AuthMethodCreateOCI = /*#__PURE__*/function () {
  /**
   ...
   */
  function AuthMethodCreateOCI(groupOcid, name, tenantOcid) {
    _classCallCheck(this, AuthMethodCreateOCI);
  ...
  _createClass(AuthMethodCreateOCI, null, [{
    key: "initialize",
    value: function initialize(obj, groupOcid, name, tenantOcid) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('group-ocid')) {
          obj['group-ocid'] = _ApiClient["default"].convertToType(data['group-ocid'], ['String']);
        }
        ...
        if (data.hasOwnProperty('tenant-ocid')) {
          obj['tenant-ocid'] = _ApiClient["default"].convertToType(data['tenant-ocid'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodCreateOCI.RequiredProperties),
          _step;
...
var _default = AuthMethodCreateOCI;
