    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cert-challenge')) {
          obj['cert-challenge'] = _ApiClient["default"].convertToType(data['cert-challenge'], 'String');
        }
        ...
        if (data.hasOwnProperty('disable-pafxfast')) {
          obj['disable-pafxfast'] = _ApiClient["default"].convertToType(data['disable-pafxfast'], 'String');
        }

        if (data.hasOwnProperty('gateway-spn')) {
          obj['gateway-spn'] = _ApiClient["default"].convertToType(data['gateway-spn'], 'String');
        }
        ...
        if (data.hasOwnProperty('kerberos-token')) {
          obj['kerberos-token'] = _ApiClient["default"].convertToType(data['kerberos-token'], 'String');
        }

        if (data.hasOwnProperty('kerberos-username')) {
          obj['kerberos-username'] = _ApiClient["default"].convertToType(data['kerberos-username'], 'String');
        }
        ...
        if (data.hasOwnProperty('keytab-data')) {
          obj['keytab-data'] = _ApiClient["default"].convertToType(data['keytab-data'], 'String');
        }
        ...
        if (data.hasOwnProperty('ldap-password')) {
          obj['ldap-password'] = _ApiClient["default"].convertToType(data['ldap-password'], 'String');
        }

        if (data.hasOwnProperty('oci-auth-type')) {
          obj['oci-auth-type'] = _ApiClient["default"].convertToType(data['oci-auth-type'], 'String');
        }

        if (data.hasOwnProperty('oci-group-ocid')) {
          obj['oci-group-ocid'] = _ApiClient["default"].convertToType(data['oci-group-ocid'], ['String']);
        }
        ...
        if (data.hasOwnProperty('signed-cert-challenge')) {
          obj['signed-cert-challenge'] = _ApiClient["default"].convertToType(data['signed-cert-challenge'], 'String');
        }
        ...
        if (data.hasOwnProperty('use-remote-browser')) {
          obj['use-remote-browser'] = _ApiClient["default"].convertToType(data['use-remote-browser'], 'Boolean');
        }
