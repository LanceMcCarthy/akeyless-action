 ...
 * @version 5.0.14
 */
var DynamicSecretUpdateAzure = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateAzure(name) {
    _classCallCheck(this, DynamicSecretUpdateAzure);
  ...
  _createClass(DynamicSecretUpdateAzure, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('azure-administrative-unit')) {
          obj['azure-administrative-unit'] = _ApiClient["default"].convertToType(data['azure-administrative-unit'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateAzure.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateAzure;
