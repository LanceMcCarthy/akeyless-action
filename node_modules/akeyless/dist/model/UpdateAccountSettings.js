    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed-client-type')) {
          obj['allowed-client-type'] = _ApiClient["default"].convertToType(data['allowed-client-type'], ['String']);
        }

        if (data.hasOwnProperty('allowed-email-domains')) {
          obj['allowed-email-domains'] = _ApiClient["default"].convertToType(data['allowed-email-domains'], ['String']);
        }
        ...
        if (data.hasOwnProperty('default-certificate-expiration-notification-days')) {
          obj['default-certificate-expiration-notification-days'] = _ApiClient["default"].convertToType(data['default-certificate-expiration-notification-days'], ['String']);
        }
        ...
        if (data.hasOwnProperty('dynamic-secret-max-ttl')) {
          obj['dynamic-secret-max-ttl'] = _ApiClient["default"].convertToType(data['dynamic-secret-max-ttl'], 'Number');
        }

        if (data.hasOwnProperty('dynamic-secret-max-ttl-enable')) {
          obj['dynamic-secret-max-ttl-enable'] = _ApiClient["default"].convertToType(data['dynamic-secret-max-ttl-enable'], 'String');
        }

        if (data.hasOwnProperty('enable-ai-insights')) {
          obj['enable-ai-insights'] = _ApiClient["default"].convertToType(data['enable-ai-insights'], 'String');
        }

        if (data.hasOwnProperty('enable-default-certificate-expiration-event')) {
          obj['enable-default-certificate-expiration-event'] = _ApiClient["default"].convertToType(data['enable-default-certificate-expiration-event'], 'String');
        }

        if (data.hasOwnProperty('enable-item-sharing')) {
          obj['enable-item-sharing'] = _ApiClient["default"].convertToType(data['enable-item-sharing'], 'String');
        }

        if (data.hasOwnProperty('enable-password-expiration')) {
          obj['enable-password-expiration'] = _ApiClient["default"].convertToType(data['enable-password-expiration'], 'String');
        }

        if (data.hasOwnProperty('force-new-versions')) {
          obj['force-new-versions'] = _ApiClient["default"].convertToType(data['force-new-versions'], 'String');
        }
        ...
        if (data.hasOwnProperty('hide-personal-folder')) {
          obj['hide-personal-folder'] = _ApiClient["default"].convertToType(data['hide-personal-folder'], 'String');
        }

        if (data.hasOwnProperty('hide-static-password')) {
          obj['hide-static-password'] = _ApiClient["default"].convertToType(data['hide-static-password'], 'String');
        }
        ...
        if (data.hasOwnProperty('lock-allowed-client-type')) {
          obj['lock-allowed-client-type'] = _ApiClient["default"].convertToType(data['lock-allowed-client-type'], 'String');
        }

        if (data.hasOwnProperty('lock-bound-ips')) {
          obj['lock-bound-ips'] = _ApiClient["default"].convertToType(data['lock-bound-ips'], 'String');
        }
        ...
        if (data.hasOwnProperty('lock-gw-bound-ips')) {
          obj['lock-gw-bound-ips'] = _ApiClient["default"].convertToType(data['lock-gw-bound-ips'], 'String');
        }

        if (data.hasOwnProperty('max-rotation-interval')) {
          obj['max-rotation-interval'] = _ApiClient["default"].convertToType(data['max-rotation-interval'], 'Number');
        }

        if (data.hasOwnProperty('max-rotation-interval-enable')) {
          obj['max-rotation-interval-enable'] = _ApiClient["default"].convertToType(data['max-rotation-interval-enable'], 'String');
        }
        ...
        if (data.hasOwnProperty('password-expiration-days')) {
          obj['password-expiration-days'] = _ApiClient["default"].convertToType(data['password-expiration-days'], 'String');
        }

        if (data.hasOwnProperty('password-expiration-notification-days')) {
          obj['password-expiration-notification-days'] = _ApiClient["default"].convertToType(data['password-expiration-notification-days'], 'String');
        }
        ...
        if (data.hasOwnProperty('usage-event-enable')) {
          obj['usage-event-enable'] = _ApiClient["default"].convertToType(data['usage-event-enable'], 'String');
        }

        if (data.hasOwnProperty('usage-event-interval')) {
          obj['usage-event-interval'] = _ApiClient["default"].convertToType(data['usage-event-interval'], 'Number');
        }

        if (data.hasOwnProperty('usage-event-object-type')) {
          obj['usage-event-object-type'] = _ApiClient["default"].convertToType(data['usage-event-object-type'], 'String');
        }

        if (data.hasOwnProperty('use-capital-letters')) {
          obj['use-capital-letters'] = _ApiClient["default"].convertToType(data['use-capital-letters'], 'String');
        }
