 ...
 * @version 5.0.1
 */
var TargetCreateDockerhub = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateDockerhub</code>.
   * @alias module:model/TargetCreateDockerhub
   * @param name {String} Target name
   */
  function TargetCreateDockerhub(name) {
    _classCallCheck(this, TargetCreateDockerhub);
  ...
  _createClass(TargetCreateDockerhub, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateDockerhub.RequiredProperties),
          _step;
...
var _default = TargetCreateDockerhub;
