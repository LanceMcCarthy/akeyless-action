 ...
 * @version 5.0.1
 */
var CustomerFragmentConfig = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CustomerFragmentConfig</code>.
   * @alias module:model/CustomerFragmentConfig
   */
  function CustomerFragmentConfig() {
    _classCallCheck(this, CustomerFragmentConfig);
  ...
  _createClass(CustomerFragmentConfig, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fragment_type')) {
          obj['fragment_type'] = _ApiClient["default"].convertToType(data['fragment_type'], 'String');
        }
        ...
        if (data.hasOwnProperty('key_label')) {
          obj['key_label'] = _ApiClient["default"].convertToType(data['key_label'], 'String');
        }
...
var _default = CustomerFragmentConfig;
