 ...
 * @version 5.0.1
 */
var TargetCreateGithub = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateGithub</code>.
   * @alias module:model/TargetCreateGithub
   * @param name {String} Target name
   */
  function TargetCreateGithub(name) {
    _classCallCheck(this, TargetCreateGithub);
  ...
  _createClass(TargetCreateGithub, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateGithub.RequiredProperties),
          _step;
...
var _default = TargetCreateGithub;
