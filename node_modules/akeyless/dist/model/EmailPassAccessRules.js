    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('last_reset_password')) {
          obj['last_reset_password'] = _ApiClient["default"].convertToType(data['last_reset_password'], 'Date');
        }

        if (data.hasOwnProperty('mfa_type')) {
          obj['mfa_type'] = _ApiClient["default"].convertToType(data['mfa_type'], 'String');
        }
      }
