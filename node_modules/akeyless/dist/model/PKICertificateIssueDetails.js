    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_ip_sans')) {
          obj['allowed_ip_sans'] = _ApiClient["default"].convertToType(data['allowed_ip_sans'], ['String']);
        }
        ...
        if (data.hasOwnProperty('create_private_ocsp')) {
          obj['create_private_ocsp'] = _ApiClient["default"].convertToType(data['create_private_ocsp'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('create_public_ocsp')) {
          obj['create_public_ocsp'] = _ApiClient["default"].convertToType(data['create_public_ocsp'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('disable_wildcards')) {
          obj['disable_wildcards'] = _ApiClient["default"].convertToType(data['disable_wildcards'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('ocsp_next_update')) {
          obj['ocsp_next_update'] = _ApiClient["default"].convertToType(data['ocsp_next_update'], 'Number');
        }
