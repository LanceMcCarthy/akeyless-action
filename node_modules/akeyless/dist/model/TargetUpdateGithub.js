 ...
 * @version 5.0.8
 */
var TargetUpdateGithub = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateGithub</code>.
   * @alias module:model/TargetUpdateGithub
   * @param name {String} Target name
   */
  function TargetUpdateGithub(name) {
    _classCallCheck(this, TargetUpdateGithub);
  ...
  _createClass(TargetUpdateGithub, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateGithub.RequiredProperties),
          _step;
...
var _default = TargetUpdateGithub;
