...
var CreateSSHCertIssuer = /*#__PURE__*/function () {
  ...
  _createClass(CreateSSHCertIssuer, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('secure-access-enforce-hosts-restriction')) {
          obj['secure-access-enforce-hosts-restriction'] = _ApiClient["default"].convertToType(data['secure-access-enforce-hosts-restriction'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateSSHCertIssuer.RequiredProperties),
          _step;
