 ...
 * @version 5.0.14
 */
var GodaddyTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GodaddyTargetDetails</code>.
   * GodaddyTargetDetails
   * @alias module:model/GodaddyTargetDetails
   */
  function GodaddyTargetDetails() {
    _classCallCheck(this, GodaddyTargetDetails);
  ...
  _createClass(GodaddyTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shopper_id')) {
          obj['shopper_id'] = _ApiClient["default"].convertToType(data['shopper_id'], 'String');
        }
...
var _default = GodaddyTargetDetails;
