 ...
 * @version 5.0.14
 */
var RotatedSecretCreateCustom = /*#__PURE__*/function () {
  /**
   ...
   */
  function RotatedSecretCreateCustom(name, targetName) {
    _classCallCheck(this, RotatedSecretCreateCustom);
  ...
  _createClass(RotatedSecretCreateCustom, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('enable-password-policy')) {
          obj['enable-password-policy'] = _ApiClient["default"].convertToType(data['enable-password-policy'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretCreateCustom.RequiredProperties),
          _step;
...
var _default = RotatedSecretCreateCustom;
