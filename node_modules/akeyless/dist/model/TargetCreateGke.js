 ...
 * @version 5.0.6
 */
var TargetCreateGke = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateGke</code>.
   * @alias module:model/TargetCreateGke
   * @param name {String} Target name
   */
  function TargetCreateGke(name) {
    _classCallCheck(this, TargetCreateGke);
  ...
  _createClass(TargetCreateGke, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateGke.RequiredProperties),
          _step;
