 ...
 * @version 5.0.0
 */
var GatewayCreateProducerGoogleWorkspaceOutput = /*#__PURE__*/function () {
  /**
   ...
   */
  function GatewayCreateProducerGoogleWorkspaceOutput() {
    _classCallCheck(this, GatewayCreateProducerGoogleWorkspaceOutput);
  ...
  _createClass(GatewayCreateProducerGoogleWorkspaceOutput, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      if (data['producer_details']) {
        // data not null
        _DSProducerDetails["default"].validateJSON(data['producer_details']);
      }
...
var _default = GatewayCreateProducerGoogleWorkspaceOutput;
