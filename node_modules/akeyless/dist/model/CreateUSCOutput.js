 ...
 * @version 4.2.0
 */
var CreateUSCOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateUSCOutput</code>.
   * @alias module:model/CreateUSCOutput
   */
  function CreateUSCOutput() {
    _classCallCheck(this, CreateUSCOutput);
  ...
  _createClass(CreateUSCOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('universal_secrets_connector_id')) {
          obj['universal_secrets_connector_id'] = _ApiClient["default"].convertToType(data['universal_secrets_connector_id'], 'Number');
        }

        if (data.hasOwnProperty('universal_secrets_connector_name')) {
          obj['universal_secrets_connector_name'] = _ApiClient["default"].convertToType(data['universal_secrets_connector_name'], 'String');
        }
      }
