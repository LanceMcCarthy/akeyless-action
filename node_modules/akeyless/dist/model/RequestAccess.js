...
var RequestAccess = /*#__PURE__*/function () {
   ...
   */
  function RequestAccess(capability, name, type) {
  ...
  _createClass(RequestAccess, null, [{
    key: "initialize",
    value: function initialize(obj, capability, name, type) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RequestAccess.RequiredProperties),
          _step;
