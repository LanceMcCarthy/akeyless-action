 ...
 * @version 5.0.0
 */
var ChangeAdminAccountPassword = /*#__PURE__*/function () {
  /**
   ...
   */
  function ChangeAdminAccountPassword(currentPassword, newPassword) {
    _classCallCheck(this, ChangeAdminAccountPassword);
  ...
  _createClass(ChangeAdminAccountPassword, null, [{
    key: "initialize",
    value: function initialize(obj, currentPassword, newPassword) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('current-password')) {
          obj['current-password'] = _ApiClient["default"].convertToType(data['current-password'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ChangeAdminAccountPassword.RequiredProperties),
          _step;
...
var _default = ChangeAdminAccountPassword;
