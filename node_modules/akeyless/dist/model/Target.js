  ...
  _createClass(Target, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('parent_target_name')) {
          obj['parent_target_name'] = _ApiClient["default"].convertToType(data['parent_target_name'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['target_items_assoc']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['target_items_assoc']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _TargetItemAssociation["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['target_versions']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['target_versions']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ItemVersion["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
