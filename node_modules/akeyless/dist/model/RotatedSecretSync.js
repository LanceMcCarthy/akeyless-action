...
var RotatedSecretSync = /*#__PURE__*/function () {
  ...
  _createClass(RotatedSecretSync, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('DeleteRemote')) {
          obj['DeleteRemote'] = _ApiClient["default"].convertToType(data['DeleteRemote'], 'Boolean');
        }

        if (data.hasOwnProperty('filter-secret-value')) {
          obj['filter-secret-value'] = _ApiClient["default"].convertToType(data['filter-secret-value'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretSync.RequiredProperties),
          _step;
...
var _default = RotatedSecretSync;
