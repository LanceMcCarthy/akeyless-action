...
var _KubeconfigUserExec = _interopRequireDefault(require("./KubeconfigUserExec"));
 ...
 * @version 5.0.14
 */
var KubeconfigUser = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KubeconfigUser</code>.
   * @alias module:model/KubeconfigUser
   */
  function KubeconfigUser() {
    _classCallCheck(this, KubeconfigUser);
  ...
  _createClass(KubeconfigUser, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('user')) {
          obj['user'] = _KubeconfigUserExec["default"].constructFromObject(data['user']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['user']) {
        // data not null
        _KubeconfigUserExec["default"].validateJSON(data['user']);
      }
