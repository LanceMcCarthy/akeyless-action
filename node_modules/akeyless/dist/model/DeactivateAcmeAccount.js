 ...
 * @version 5.0.0
 */
var DeactivateAcmeAccount = /*#__PURE__*/function () {
  /**
   ...
   */
  function DeactivateAcmeAccount(acmeAccountId, certIssuerName) {
    _classCallCheck(this, DeactivateAcmeAccount);
  ...
  _createClass(DeactivateAcmeAccount, null, [{
    key: "initialize",
    value: function initialize(obj, acmeAccountId, certIssuerName) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('acme-account-id')) {
          obj['acme-account-id'] = _ApiClient["default"].convertToType(data['acme-account-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('delete-account')) {
          obj['delete-account'] = _ApiClient["default"].convertToType(data['delete-account'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeactivateAcmeAccount.RequiredProperties),
          _step;
...
var _default = DeactivateAcmeAccount;
