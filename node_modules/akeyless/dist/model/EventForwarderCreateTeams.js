 ...
 * @version 5.0.14
 */
var EventForwarderCreateTeams = /*#__PURE__*/function () {
  /**
   ...
   */
  function EventForwarderCreateTeams(gatewaysEventSourceLocations, name, runnerType, url) {
    _classCallCheck(this, EventForwarderCreateTeams);
  ...
  _createClass(EventForwarderCreateTeams, null, [{
    key: "initialize",
    value: function initialize(obj, gatewaysEventSourceLocations, name, runnerType, url) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EventForwarderCreateTeams.RequiredProperties),
          _step;
...
var _default = EventForwarderCreateTeams;
