 ...
 * @version 5.0.8
 */
var TargetUpdateGitlab = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateGitlab</code>.
   * @alias module:model/TargetUpdateGitlab
   * @param name {String} Target name
   */
  function TargetUpdateGitlab(name) {
    _classCallCheck(this, TargetUpdateGitlab);
  ...
  _createClass(TargetUpdateGitlab, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateGitlab.RequiredProperties),
          _step;
...
var _default = TargetUpdateGitlab;
