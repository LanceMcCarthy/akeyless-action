 ...
 * @version 5.0.5
 */
var TargetCreateAws = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetCreateAws(accessKey, accessKeyId, name) {
    _classCallCheck(this, TargetCreateAws);
  ...
  _createClass(TargetCreateAws, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('generate-external-id')) {
          obj['generate-external-id'] = _ApiClient["default"].convertToType(data['generate-external-id'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateAws.RequiredProperties),
          _step;
