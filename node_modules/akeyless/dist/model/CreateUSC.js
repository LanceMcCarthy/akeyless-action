 ...
 * @version 5.0.20
 */
var CreateUSC = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateUSC(name, targetToAssociate) {
    _classCallCheck(this, CreateUSC);
  ...
  _createClass(CreateUSC, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('usc-prefix')) {
          obj['usc-prefix'] = _ApiClient["default"].convertToType(data['usc-prefix'], 'String');
        }

        if (data.hasOwnProperty('use-prefix-as-filter')) {
          obj['use-prefix-as-filter'] = _ApiClient["default"].convertToType(data['use-prefix-as-filter'], 'String');
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateUSC.RequiredProperties),
          _step;
