 ...
 * @version 5.0.14
 */
var DynamicSecretCreateSnowflake = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretCreateSnowflake(name) {
    _classCallCheck(this, DynamicSecretCreateSnowflake);
  ...
  _createClass(DynamicSecretCreateSnowflake, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('auth-mode')) {
          obj['auth-mode'] = _ApiClient["default"].convertToType(data['auth-mode'], 'String');
        }
        ...
        if (data.hasOwnProperty('key-algo')) {
          obj['key-algo'] = _ApiClient["default"].convertToType(data['key-algo'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretCreateSnowflake.RequiredProperties),
          _step;
...
var _default = DynamicSecretCreateSnowflake;
