 ...
 * @version 5.0.8
 */
var SectigoTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SectigoTargetDetails</code>.
   * SectigoTargetDetails
   * @alias module:model/SectigoTargetDetails
   */
  function SectigoTargetDetails() {
    _classCallCheck(this, SectigoTargetDetails);
  ...
  _createClass(SectigoTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('certificate_profile_id')) {
          obj['certificate_profile_id'] = _ApiClient["default"].convertToType(data['certificate_profile_id'], 'Number');
        }

        if (data.hasOwnProperty('customer_uri')) {
          obj['customer_uri'] = _ApiClient["default"].convertToType(data['customer_uri'], 'String');
        }

        if (data.hasOwnProperty('external_requester')) {
          obj['external_requester'] = _ApiClient["default"].convertToType(data['external_requester'], 'String');
        }
...
var _default = SectigoTargetDetails;
