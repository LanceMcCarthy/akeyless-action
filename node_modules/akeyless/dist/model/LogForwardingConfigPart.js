...
var LogForwardingConfigPart = /*#__PURE__*/function () {
  ...
  _createClass(LogForwardingConfigPart, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['aws_s3_config']) {
        // data not null
        _AwsS3LogForwardingConfig["default"].validateJSON(data['aws_s3_config']);
      } // validate the optional field `azure_analytics_config`


      if (data['azure_analytics_config']) {
        // data not null
        _AzureLogAnalyticsForwardingConfig["default"].validateJSON(data['azure_analytics_config']);
      } // validate the optional field `datadog_config`


      if (data['datadog_config']) {
        // data not null
        _DatadogForwardingConfig["default"].validateJSON(data['datadog_config']);
      } // validate the optional field `elasticsearch_config`


      if (data['elasticsearch_config']) {
        // data not null
        _ElasticsearchLogForwardingConfig["default"].validateJSON(data['elasticsearch_config']);
      } // validate the optional field `google_chronicle_config`


      if (data['google_chronicle_config']) {
        // data not null
        _GoogleChronicleForwardingConfig["default"].validateJSON(data['google_chronicle_config']);
      ...
      if (data['logstash_config']) {
        // data not null
        _LogstashLogForwardingConfig["default"].validateJSON(data['logstash_config']);
      } // validate the optional field `logz_io_config`


      if (data['logz_io_config']) {
        // data not null
        _LogzIoLogForwardingConfig["default"].validateJSON(data['logz_io_config']);
      } // ensure the json data is a string
      ...
      if (data['splunk_config']) {
        // data not null
        _SplunkLogForwardingConfig["default"].validateJSON(data['splunk_config']);
      } // validate the optional field `sumo_logic_config`


      if (data['sumo_logic_config']) {
        // data not null
        _SumologicLogForwardingConfig["default"].validateJSON(data['sumo_logic_config']);
      } // validate the optional field `syslog_config`


      if (data['syslog_config']) {
        // data not null
        _SyslogLogForwardingConfig["default"].validateJSON(data['syslog_config']);
      } // ensure the json data is a string
