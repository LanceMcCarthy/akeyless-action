  ...
  _createClass(Name, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['ExtraNames']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['ExtraNames']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _AttributeTypeAndValue["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['Names']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['Names']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _AttributeTypeAndValue["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
