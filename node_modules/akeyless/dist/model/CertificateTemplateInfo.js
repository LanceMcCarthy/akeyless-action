    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('csr_cnf_base_64')) {
          obj['csr_cnf_base_64'] = _ApiClient["default"].convertToType(data['csr_cnf_base_64'], 'String');
        }
        ...
        if (data.hasOwnProperty('hash_algorithm')) {
          obj['hash_algorithm'] = _ApiClient["default"].convertToType(data['hash_algorithm'], 'String');
        }
