...
var MigrationStatusReplyObj = /*#__PURE__*/function () {
  ...
  _createClass(MigrationStatusReplyObj, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('computers')) {
          obj['computers'] = _ApiClient["default"].convertToType(data['computers'], 'Number');
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['migration_items']) {
        // data not null
        _MigrationItems["default"].validateJSON(data['migration_items']);
      } // ensure the json data is a string
      ...
      if (data['rotated_secrets']) {
        // data not null
        _MigrationItems["default"].validateJSON(data['rotated_secrets']);
      } // ensure the json data is a string
      ...
      if (data['targets']) {
        // data not null
        _MigrationItems["default"].validateJSON(data['targets']);
      }
