 ...
 * @version 5.0.1
 */
var KubeconfigContext = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KubeconfigContext</code>.
   * @alias module:model/KubeconfigContext
   */
  function KubeconfigContext() {
    _classCallCheck(this, KubeconfigContext);
  ...
  _createClass(KubeconfigContext, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cluster')) {
          obj['cluster'] = _ApiClient["default"].convertToType(data['cluster'], 'String');
        }
...
var _default = KubeconfigContext;
