 ...
 * @version 5.0.6
 */
var TargetUpdateDB = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetUpdateDB(connectionType, dbType, name) {
    _classCallCheck(this, TargetUpdateDB);
  ...
  _createClass(TargetUpdateDB, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('oracle-wallet-login-type')) {
          obj['oracle-wallet-login-type'] = _ApiClient["default"].convertToType(data['oracle-wallet-login-type'], 'String');
        }

        if (data.hasOwnProperty('oracle-wallet-p12-file-data')) {
          obj['oracle-wallet-p12-file-data'] = _ApiClient["default"].convertToType(data['oracle-wallet-p12-file-data'], 'String');
        }

        if (data.hasOwnProperty('oracle-wallet-sso-file-data')) {
          obj['oracle-wallet-sso-file-data'] = _ApiClient["default"].convertToType(data['oracle-wallet-sso-file-data'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateDB.RequiredProperties),
          _step;
