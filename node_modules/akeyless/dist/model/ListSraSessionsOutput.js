...
var _SraSessionEntryOut = _interopRequireDefault(require("./SraSessionEntryOut"));
 ...
 * @version 5.0.6
 */
var ListSraSessionsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListSraSessionsOutput</code>.
   * @alias module:model/ListSraSessionsOutput
   */
  function ListSraSessionsOutput() {
    _classCallCheck(this, ListSraSessionsOutput);
  ...
  _createClass(ListSraSessionsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_gateways')) {
          obj['allowed_gateways'] = _ApiClient["default"].convertToType(data['allowed_gateways'], [_GatewayNameInfo["default"]]);
        }
        ...
        if (data.hasOwnProperty('sessions')) {
          obj['sessions'] = _ApiClient["default"].convertToType(data['sessions'], [_SraSessionEntryOut["default"]]);
        }
      }
    ...
    value: function validateJSON(data) {
      if (data['allowed_gateways']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['allowed_gateways']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _GatewayNameInfo["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['sessions']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _SraSessionEntryOut["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = ListSraSessionsOutput;
