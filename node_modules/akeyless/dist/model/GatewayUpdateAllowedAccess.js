...
var GatewayUpdateAllowedAccess = /*#__PURE__*/function () {
  ...
  _createClass(GatewayUpdateAllowedAccess, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('SubClaimsCaseInsensitive')) {
          obj['SubClaimsCaseInsensitive'] = _ApiClient["default"].convertToType(data['SubClaimsCaseInsensitive'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GatewayUpdateAllowedAccess.RequiredProperties),
          _step;
