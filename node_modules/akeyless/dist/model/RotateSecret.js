...
var RotateSecret = /*#__PURE__*/function () {
  ...
  _createClass(RotateSecret, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('RotateAllServicesBoolean')) {
          obj['RotateAllServicesBoolean'] = _ApiClient["default"].convertToType(data['RotateAllServicesBoolean'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('rotate-all-services')) {
          obj['rotate-all-services'] = _ApiClient["default"].convertToType(data['rotate-all-services'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotateSecret.RequiredProperties),
          _step;
