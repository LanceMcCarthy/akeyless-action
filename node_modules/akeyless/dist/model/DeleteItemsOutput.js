    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('deleted_items')) {
          obj['deleted_items'] = _ApiClient["default"].convertToType(data['deleted_items'], ['String']);
        }

        if (data.hasOwnProperty('failed_deleted_items')) {
          obj['failed_deleted_items'] = _ApiClient["default"].convertToType(data['failed_deleted_items'], {
            'String': 'String'
          });
        }
