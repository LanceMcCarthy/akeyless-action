 ...
 * @version 5.0.0
 */
var ProvisionCertificateOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ProvisionCertificateOutput</code>.
   * @alias module:model/ProvisionCertificateOutput
   */
  function ProvisionCertificateOutput() {
    _classCallCheck(this, ProvisionCertificateOutput);
  ...
  _createClass(ProvisionCertificateOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('FailMessage')) {
          obj['FailMessage'] = _ApiClient["default"].convertToType(data['FailMessage'], 'String');
        }

        if (data.hasOwnProperty('SuccessMessage')) {
          obj['SuccessMessage'] = _ApiClient["default"].convertToType(data['SuccessMessage'], 'String');
        }

        if (data.hasOwnProperty('host_names')) {
          obj['host_names'] = _ApiClient["default"].convertToType(data['host_names'], ['String']);
        }

        if (data.hasOwnProperty('provisioned_at')) {
          obj['provisioned_at'] = _ApiClient["default"].convertToType(data['provisioned_at'], 'Date');
        }
      }
...
var _default = ProvisionCertificateOutput;
