 ...
 * @version 5.0.0
 */
var GenerateCA = /*#__PURE__*/function () {
  /**
   ...
   */
  function GenerateCA(allowedDomains, pkiChainName, ttl) {
    _classCallCheck(this, GenerateCA);
  ...
  _createClass(GenerateCA, null, [{
    key: "initialize",
    value: function initialize(obj, allowedDomains, pkiChainName, ttl) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('key-type')) {
          obj['key-type'] = _ApiClient["default"].convertToType(data['key-type'], 'String');
        }
        ...
        if (data.hasOwnProperty('pki-chain-name')) {
          obj['pki-chain-name'] = _ApiClient["default"].convertToType(data['pki-chain-name'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GenerateCA.RequiredProperties),
          _step;
