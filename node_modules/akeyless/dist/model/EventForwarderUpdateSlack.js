 ...
 * @version 5.0.14
 */
var EventForwarderUpdateSlack = /*#__PURE__*/function () {
  /**
   ...
   */
  function EventForwarderUpdateSlack(gatewaysEventSourceLocations, name, url) {
    _classCallCheck(this, EventForwarderUpdateSlack);
  ...
  _createClass(EventForwarderUpdateSlack, null, [{
    key: "initialize",
    value: function initialize(obj, gatewaysEventSourceLocations, name, url) {
      obj['enable'] = 'true';
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(EventForwarderUpdateSlack.RequiredProperties),
          _step;
...
var _default = EventForwarderUpdateSlack;
