...
var ShareItem = /*#__PURE__*/function () {
  ...
  _createClass(ShareItem, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('share-type')) {
          obj['share-type'] = _ApiClient["default"].convertToType(data['share-type'], 'String');
        }

        if (data.hasOwnProperty('shared-token-id')) {
          obj['shared-token-id'] = _ApiClient["default"].convertToType(data['shared-token-id'], ['String']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ShareItem.RequiredProperties),
          _step;
