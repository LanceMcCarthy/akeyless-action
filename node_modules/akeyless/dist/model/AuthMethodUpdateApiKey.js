 ...
 * @version 5.0.20
 */
var AuthMethodUpdateApiKey = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AuthMethodUpdateApiKey</code>.
   * @alias module:model/AuthMethodUpdateApiKey
   * @param name {String} Auth Method name
   */
  function AuthMethodUpdateApiKey(name) {
    _classCallCheck(this, AuthMethodUpdateApiKey);
  ...
  _createClass(AuthMethodUpdateApiKey, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodUpdateApiKey.RequiredProperties),
          _step;
...
var _default = AuthMethodUpdateApiKey;
