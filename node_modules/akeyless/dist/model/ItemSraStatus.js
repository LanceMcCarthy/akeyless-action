 ...
 * @version 4.2.1
 */
var ItemSraStatus = /*#__PURE__*/function () {
  /**
  ...
  _createClass(ItemSraStatus, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('count_by_host_info')) {
          obj['count_by_host_info'] = _ApiClient["default"].convertToType(data['count_by_host_info'], {
            'String': 'Number'
          });
        }

        if (data.hasOwnProperty('count_info')) {
          obj['count_info'] = _ApiClient["default"].convertToType(data['count_info'], {
            'String': {
              'String': 'Number'
            }
          });
        ...
        if (data.hasOwnProperty('hosts_in_use')) {
          obj['hosts_in_use'] = _ApiClient["default"].convertToType(data['hosts_in_use'], ['String']);
        }

        if (data.hasOwnProperty('is_in_use')) {
          obj['is_in_use'] = _ApiClient["default"].convertToType(data['is_in_use'], 'Boolean');
        }

        if (data.hasOwnProperty('last_used_item')) {
          obj['last_used_item'] = _ApiClient["default"].convertToType(data['last_used_item'], 'Date');
        }
      }
