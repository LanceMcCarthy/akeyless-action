 ...
 * @version 5.0.14
 */
var RotatedSecretCreateAzure = /*#__PURE__*/function () {
  /**
   ...
   */
  function RotatedSecretCreateAzure(name, rotatorType, targetName) {
    _classCallCheck(this, RotatedSecretCreateAzure);
  ...
  _createClass(RotatedSecretCreateAzure, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('explicitly-set-sa')) {
          obj['explicitly-set-sa'] = _ApiClient["default"].convertToType(data['explicitly-set-sa'], 'String');
        }
        ...
        if (data.hasOwnProperty('grace-rotation-hour')) {
          obj['grace-rotation-hour'] = _ApiClient["default"].convertToType(data['grace-rotation-hour'], 'Number');
        }

        if (data.hasOwnProperty('grace-rotation-interval')) {
          obj['grace-rotation-interval'] = _ApiClient["default"].convertToType(data['grace-rotation-interval'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-disable-concurrent-connections')) {
          obj['secure-access-disable-concurrent-connections'] = _ApiClient["default"].convertToType(data['secure-access-disable-concurrent-connections'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretCreateAzure.RequiredProperties),
          _step;
...
var _default = RotatedSecretCreateAzure;
