...
var UpdateItem = /*#__PURE__*/function () {
  ...
  _createClass(UpdateItem, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('certificate-format')) {
          obj['certificate-format'] = _ApiClient["default"].convertToType(data['certificate-format'], 'String');
        }
        ...
        if (data.hasOwnProperty('gcp-sm-regions')) {
          obj['gcp-sm-regions'] = _ApiClient["default"].convertToType(data['gcp-sm-regions'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-api')) {
          obj['secure-access-api'] = _ApiClient["default"].convertToType(data['secure-access-api'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-gateway')) {
          obj['secure-access-gateway'] = _ApiClient["default"].convertToType(data['secure-access-gateway'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-ssh')) {
          obj['secure-access-ssh'] = _ApiClient["default"].convertToType(data['secure-access-ssh'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-use-internal-ssh-access')) {
          obj['secure-access-use-internal-ssh-access'] = _ApiClient["default"].convertToType(data['secure-access-use-internal-ssh-access'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateItem.RequiredProperties),
          _step;
