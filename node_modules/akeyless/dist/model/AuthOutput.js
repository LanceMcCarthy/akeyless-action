...
var AuthOutput = /*#__PURE__*/function () {
  ...
  _createClass(AuthOutput, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('complete_auth_link')) {
          obj['complete_auth_link'] = _ApiClient["default"].convertToType(data['complete_auth_link'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['creds']) {
        // data not null
        _SystemAccessCredentialsReplyObj["default"].validateJSON(data['creds']);
      } // ensure the json data is a string
