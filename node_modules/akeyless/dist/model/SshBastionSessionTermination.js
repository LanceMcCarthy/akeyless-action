 ...
 * @version 5.0.6
 */
var SshBastionSessionTermination = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SshBastionSessionTermination</code>.
   * @alias module:model/SshBastionSessionTermination
   */
  function SshBastionSessionTermination() {
    _classCallCheck(this, SshBastionSessionTermination);
  ...
  _createClass(SshBastionSessionTermination, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('api_password')) {
          obj['api_password'] = _ApiClient["default"].convertToType(data['api_password'], 'String');
        }

        if (data.hasOwnProperty('api_token')) {
          obj['api_token'] = _ApiClient["default"].convertToType(data['api_token'], 'String');
        }

        if (data.hasOwnProperty('api_url')) {
          obj['api_url'] = _ApiClient["default"].convertToType(data['api_url'], 'String');
        }

        if (data.hasOwnProperty('api_username')) {
          obj['api_username'] = _ApiClient["default"].convertToType(data['api_username'], 'String');
        }
...
var _default = SshBastionSessionTermination;
