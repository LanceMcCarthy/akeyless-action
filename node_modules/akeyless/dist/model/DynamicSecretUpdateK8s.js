 ...
 * @version 5.0.14
 */
var DynamicSecretUpdateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateK8s(name) {
    _classCallCheck(this, DynamicSecretUpdateK8s);
  ...
  _createClass(DynamicSecretUpdateK8s, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('k8s-cluster-name')) {
          obj['k8s-cluster-name'] = _ApiClient["default"].convertToType(data['k8s-cluster-name'], 'String');
        }
        ...
        if (data.hasOwnProperty('k8s-rolebinding-yaml-data')) {
          obj['k8s-rolebinding-yaml-data'] = _ApiClient["default"].convertToType(data['k8s-rolebinding-yaml-data'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateK8s.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateK8s;
