 ...
 * @version 5.0.14
 */
var GwUpdateRemoteAccessSessionLogsSumologic = /*#__PURE__*/function () {
  /**
   ...
   */
  function GwUpdateRemoteAccessSessionLogsSumologic() {
    _classCallCheck(this, GwUpdateRemoteAccessSessionLogsSumologic);
  ...
  _createClass(GwUpdateRemoteAccessSessionLogsSumologic, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('sumologic-tags')) {
          obj['sumologic-tags'] = _ApiClient["default"].convertToType(data['sumologic-tags'], 'String');
        }
...
var _default = GwUpdateRemoteAccessSessionLogsSumologic;
