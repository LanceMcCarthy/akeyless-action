 ...
 * @version 5.0.5
 */
var DynamicSecretMaxTtl = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DynamicSecretMaxTtl</code>.
   * @alias module:model/DynamicSecretMaxTtl
   */
  function DynamicSecretMaxTtl() {
    _classCallCheck(this, DynamicSecretMaxTtl);
  ...
  _createClass(DynamicSecretMaxTtl, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('max_ttl_by_minutes')) {
          obj['max_ttl_by_minutes'] = _ApiClient["default"].convertToType(data['max_ttl_by_minutes'], 'Number');
        }
      }
...
var _default = DynamicSecretMaxTtl;
