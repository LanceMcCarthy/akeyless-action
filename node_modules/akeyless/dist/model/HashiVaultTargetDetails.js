 ...
 * @version 5.0.0
 */
var HashiVaultTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>HashiVaultTargetDetails</code>.
   * HashiVaultTargetDetails
   * @alias module:model/HashiVaultTargetDetails
   */
  function HashiVaultTargetDetails() {
    _classCallCheck(this, HashiVaultTargetDetails);
  ...
  _createClass(HashiVaultTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vault_namespaces')) {
          obj['vault_namespaces'] = _ApiClient["default"].convertToType(data['vault_namespaces'], 'String');
        }

        if (data.hasOwnProperty('vault_token')) {
          obj['vault_token'] = _ApiClient["default"].convertToType(data['vault_token'], 'String');
        }

        if (data.hasOwnProperty('vault_url')) {
          obj['vault_url'] = _ApiClient["default"].convertToType(data['vault_url'], 'String');
        }
      }
...
var _default = HashiVaultTargetDetails;
