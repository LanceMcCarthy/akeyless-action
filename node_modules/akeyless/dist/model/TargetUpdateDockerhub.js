 ...
 * @version 5.0.0
 */
var TargetUpdateDockerhub = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateDockerhub</code>.
   * @alias module:model/TargetUpdateDockerhub
   * @param name {String} Target name
   */
  function TargetUpdateDockerhub(name) {
    _classCallCheck(this, TargetUpdateDockerhub);
  ...
  _createClass(TargetUpdateDockerhub, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateDockerhub.RequiredProperties),
          _step;
...
var _default = TargetUpdateDockerhub;
