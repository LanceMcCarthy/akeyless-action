...
var _ItemSraStatus = _interopRequireDefault(require("./ItemSraStatus"));

var _TargetNameWithHosts = _interopRequireDefault(require("./TargetNameWithHosts"));
...
var SecureRemoteAccess = /*#__PURE__*/function () {
  ...
  _createClass(SecureRemoteAccess, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('block_concurrent_connections')) {
          obj['block_concurrent_connections'] = _ApiClient["default"].convertToType(data['block_concurrent_connections'], 'Boolean');
        }

        if (data.hasOwnProperty('block_concurrent_connections_level')) {
          obj['block_concurrent_connections_level'] = _ApiClient["default"].convertToType(data['block_concurrent_connections_level'], 'String');
        }
        ...
        if (data.hasOwnProperty('connection_delay_seconds')) {
          obj['connection_delay_seconds'] = _ApiClient["default"].convertToType(data['connection_delay_seconds'], 'Number');
        }
        ...
        if (data.hasOwnProperty('enforce_hosts_restriction')) {
          obj['enforce_hosts_restriction'] = _ApiClient["default"].convertToType(data['enforce_hosts_restriction'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('host_provider_type')) {
          obj['host_provider_type'] = _ApiClient["default"].convertToType(data['host_provider_type'], 'String');
        }
        ...
        if (data.hasOwnProperty('is_desktop_app')) {
          obj['is_desktop_app'] = _ApiClient["default"].convertToType(data['is_desktop_app'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('status_info')) {
          obj['status_info'] = _ItemSraStatus["default"].constructFromObject(data['status_info']);
        }

        if (data.hasOwnProperty('target_hosts')) {
          obj['target_hosts'] = _ApiClient["default"].convertToType(data['target_hosts'], [_TargetNameWithHosts["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['status_info']) {
        // data not null
        _ItemSraStatus["default"].validateJSON(data['status_info']);
      }
      ...
      if (data['target_hosts']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['target_hosts']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _TargetNameWithHosts["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
