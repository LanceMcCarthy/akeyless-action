...
var _GatewayDetailsForItemReplyObj = _interopRequireDefault(require("./GatewayDetailsForItemReplyObj"));
...
var _ItemUSCSyncAssociation = _interopRequireDefault(require("./ItemUSCSyncAssociation"));
...
var Item = /*#__PURE__*/function () {
  ...
  _createClass(Item, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gateway_details')) {
          obj['gateway_details'] = _ApiClient["default"].convertToType(data['gateway_details'], [_GatewayDetailsForItemReplyObj["default"]]);
        }
        ...
        if (data.hasOwnProperty('last_rotation_date')) {
          obj['last_rotation_date'] = _ApiClient["default"].convertToType(data['last_rotation_date'], 'Date');
        }
        ...
        if (data.hasOwnProperty('usc_sync_associated_items')) {
          obj['usc_sync_associated_items'] = _ApiClient["default"].convertToType(data['usc_sync_associated_items'], [_ItemUSCSyncAssociation["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['bastion_details']) {
        // data not null
        _BastionsList["default"].validateJSON(data['bastion_details']);
      } // ensure the json data is a string
      ...
      if (data['certificate_issue_details']) {
        // data not null
        _CertificateIssueInfo["default"].validateJSON(data['certificate_issue_details']);
      } // ensure the json data is a string
      ...
      if (data['gateway_details']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['gateway_details']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _GatewayDetailsForItemReplyObj["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['item_custom_fields_details']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['item_custom_fields_details']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ItemCustomFieldsDetails["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['item_general_info']) {
        // data not null
        _ItemGeneralInfo["default"].validateJSON(data['item_general_info']);
      } // ensure the json data is a string
      ...
      if (data['item_targets_assoc']) {
        ...
        var _iterator3 = _createForOfIteratorHelper(data['item_targets_assoc']),
            _step3;
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ItemTargetAssociation["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['item_versions']) {
        ...
        var _iterator4 = _createForOfIteratorHelper(data['item_versions']),
            _step4;
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            ...
            _ItemVersion["default"].validateJSON(_item3);
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
      ...
      if (data['linked_details']) {
        // data not null
        _LinkedDetails["default"].validateJSON(data['linked_details']);
      } // ensure the json data is a string
      ...
      if (data['shared_by']) {
        // data not null
        _RuleAssigner["default"].validateJSON(data['shared_by']);
      }
      ...
      if (data['target_versions']) {
        ...
        var _iterator5 = _createForOfIteratorHelper(data['target_versions']),
            _step5;
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            _TargetItemVersion["default"].validateJSON(_item4);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
      ...
      if (data['usc_sync_associated_items']) {
        // data not null
        // ensure the json data is an array
        ...
        var _iterator6 = _createForOfIteratorHelper(data['usc_sync_associated_items']),
            _step6;
        ...
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            ...
            _ItemUSCSyncAssociation["default"].validateJSON(_item5);
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
