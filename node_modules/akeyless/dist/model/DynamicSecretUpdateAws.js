 ...
 * @version 5.0.14
 */
var DynamicSecretUpdateAws = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateAws(name) {
    _classCallCheck(this, DynamicSecretUpdateAws);
  ...
  _createClass(DynamicSecretUpdateAws, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('aws-external-id')) {
          obj['aws-external-id'] = _ApiClient["default"].convertToType(data['aws-external-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('custom-username-template')) {
          obj['custom-username-template'] = _ApiClient["default"].convertToType(data['custom-username-template'], 'String');
        }
        ...
        if (data.hasOwnProperty('session-tags')) {
          obj['session-tags'] = _ApiClient["default"].convertToType(data['session-tags'], 'String');
        }
        ...
        if (data.hasOwnProperty('transitive-tag-keys')) {
          obj['transitive-tag-keys'] = _ApiClient["default"].convertToType(data['transitive-tag-keys'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateAws.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateAws;
