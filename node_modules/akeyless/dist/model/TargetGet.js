 ...
 * @version 5.0.5
 */
var TargetGet = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetGet</code>.
   * @alias module:model/TargetGet
   * @param name {String} Target name
   */
  function TargetGet(name) {
    _classCallCheck(this, TargetGet);
  ...
  _createClass(TargetGet, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetGet.RequiredProperties),
          _step;
