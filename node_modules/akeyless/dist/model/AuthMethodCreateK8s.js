 ...
 * @version 5.0.16
 */
var AuthMethodCreateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function AuthMethodCreateK8s(name) {
    _classCallCheck(this, AuthMethodCreateK8s);
  ...
  _createClass(AuthMethodCreateK8s, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodCreateK8s.RequiredProperties),
          _step;
...
var _default = AuthMethodCreateK8s;
