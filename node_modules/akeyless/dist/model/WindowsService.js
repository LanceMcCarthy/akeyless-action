...
var _WindowsServiceAttributes = _interopRequireDefault(require("./WindowsServiceAttributes"));
...
var WindowsService = /*#__PURE__*/function () {
  ...
  _createClass(WindowsService, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('attributes')) {
          obj['attributes'] = _WindowsServiceAttributes["default"].constructFromObject(data['attributes']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['attributes']) {
        // data not null
        _WindowsServiceAttributes["default"].validateJSON(data['attributes']);
