 ...
 * @version 5.0.8
 */
var VerifyEcDsa = /*#__PURE__*/function () {
  /**
   ...
   */
  function VerifyEcDsa(message, signature) {
    _classCallCheck(this, VerifyEcDsa);
  ...
  _createClass(VerifyEcDsa, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(VerifyEcDsa.RequiredProperties),
          _step;
