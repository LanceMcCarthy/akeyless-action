 ...
 * @version 5.0.0
 */
var BatchEncryptionRequestLine = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BatchEncryptionRequestLine</code>.
   * @alias module:model/BatchEncryptionRequestLine
   */
  function BatchEncryptionRequestLine() {
    _classCallCheck(this, BatchEncryptionRequestLine);
  ...
  _createClass(BatchEncryptionRequestLine, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('context')) {
          obj['context'] = _ApiClient["default"].convertToType(data['context'], {
            'String': 'String'
          });
        }
        ...
        if (data.hasOwnProperty('item_version')) {
          obj['item_version'] = _ApiClient["default"].convertToType(data['item_version'], 'Number');
        }
      }
...
var _default = BatchEncryptionRequestLine;
