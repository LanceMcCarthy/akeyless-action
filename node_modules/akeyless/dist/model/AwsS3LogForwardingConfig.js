    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('aws_auth_type')) {
          obj['aws_auth_type'] = _ApiClient["default"].convertToType(data['aws_auth_type'], 'String');
        }
        ...
        if (data.hasOwnProperty('aws_role_arn')) {
          obj['aws_role_arn'] = _ApiClient["default"].convertToType(data['aws_role_arn'], 'String');
        }
