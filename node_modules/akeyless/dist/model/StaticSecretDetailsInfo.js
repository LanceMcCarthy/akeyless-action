...
var _PasswordSecurityInfo = _interopRequireDefault(require("./PasswordSecurityInfo"));
...
var StaticSecretDetailsInfo = /*#__PURE__*/function () {
  ...
  _createClass(StaticSecretDetailsInfo, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('notify_on_change_event')) {
          obj['notify_on_change_event'] = _ApiClient["default"].convertToType(data['notify_on_change_event'], 'Boolean');
        }

        if (data.hasOwnProperty('password_security_info')) {
          obj['password_security_info'] = _PasswordSecurityInfo["default"].constructFromObject(data['password_security_info']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['password_security_info']) {
        // data not null
        _PasswordSecurityInfo["default"].validateJSON(data['password_security_info']);
      } // ensure the json data is a string
