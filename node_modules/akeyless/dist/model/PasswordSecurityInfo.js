...
var _PasswordBreachInfo = _interopRequireDefault(require("./PasswordBreachInfo"));

var _PasswordScoreInfo = _interopRequireDefault(require("./PasswordScoreInfo"));
...
var PasswordSecurityInfo = /*#__PURE__*/function () {
  ...
  _createClass(PasswordSecurityInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('breach_info')) {
          obj['breach_info'] = _PasswordBreachInfo["default"].constructFromObject(data['breach_info']);
        }

        if (data.hasOwnProperty('score_info')) {
          obj['score_info'] = _PasswordScoreInfo["default"].constructFromObject(data['score_info']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['breach_info']) {
        // data not null
        _PasswordBreachInfo["default"].validateJSON(data['breach_info']);
      } // validate the optional field `score_info`


      if (data['score_info']) {
        // data not null
        _PasswordScoreInfo["default"].validateJSON(data['score_info']);
      }
...
var _default = PasswordSecurityInfo;
