 ...
 * @version 5.0.16
 */
var AuthMethodUpdateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function AuthMethodUpdateK8s(name) {
    _classCallCheck(this, AuthMethodUpdateK8s);
  ...
  _createClass(AuthMethodUpdateK8s, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AuthMethodUpdateK8s.RequiredProperties),
          _step;
...
var _default = AuthMethodUpdateK8s;
