 ...
 * @version 3.6.2
 */
var UsageEventSetting = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UsageEventSetting</code>.
   * @alias module:model/UsageEventSetting
   */
  function UsageEventSetting() {
    _classCallCheck(this, UsageEventSetting);
  ...
  _createClass(UsageEventSetting, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('enable_time')) {
          obj['enable_time'] = _ApiClient["default"].convertToType(data['enable_time'], 'Date');
        }

        if (data.hasOwnProperty('interval_by_days')) {
          obj['interval_by_days'] = _ApiClient["default"].convertToType(data['interval_by_days'], 'Number');
        }
      }
...
var _default = UsageEventSetting;
