...
var _KubeconfigCluster = _interopRequireDefault(require("./KubeconfigCluster"));
 ...
 * @version 5.0.0
 */
var KubeconfigNamedCluster = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KubeconfigNamedCluster</code>.
   * @alias module:model/KubeconfigNamedCluster
   */
  function KubeconfigNamedCluster() {
    _classCallCheck(this, KubeconfigNamedCluster);
  ...
  _createClass(KubeconfigNamedCluster, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cluster')) {
          obj['cluster'] = _KubeconfigCluster["default"].constructFromObject(data['cluster']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['cluster']) {
        // data not null
        _KubeconfigCluster["default"].validateJSON(data['cluster']);
...
var _default = KubeconfigNamedCluster;
