...
var _NextAutoRotationEvent = _interopRequireDefault(require("./NextAutoRotationEvent"));
...
var ItemGeneralInfo = /*#__PURE__*/function () {
  ...
  _createClass(ItemGeneralInfo, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('next_rotation_events')) {
          obj['next_rotation_events'] = _ApiClient["default"].convertToType(data['next_rotation_events'], [_NextAutoRotationEvent["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['cert_issue_details']) {
        // data not null
        _CertificateIssueInfo["default"].validateJSON(data['cert_issue_details']);
      } // validate the optional field `certificate_chain_info`


      if (data['certificate_chain_info']) {
        // data not null
        _CertificateChainInfo["default"].validateJSON(data['certificate_chain_info']);
      ...
      if (data['certificates_template_info']) {
        // data not null
        _CertificateTemplateInfo["default"].validateJSON(data['certificates_template_info']);
      } // validate the optional field `classic_key_details`


      if (data['classic_key_details']) {
        // data not null
        _ClassicKeyDetailsInfo["default"].validateJSON(data['classic_key_details']);
      } // ensure the json data is a string
      ...
      if (data['dynamic_secret_producer_details']) {
        // data not null
        _DynamicSecretProducerInfo["default"].validateJSON(data['dynamic_secret_producer_details']);
      }
      ...
      if (data['importer_info']) {
        // data not null
        _ImporterInfo["default"].validateJSON(data['importer_info']);
      }

      if (data['next_rotation_events']) {
        // data not null
        // ensure the json data is an array
        ...
        var _iterator2 = _createForOfIteratorHelper(data['next_rotation_events']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _NextAutoRotationEvent["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['oidc_client_info']) {
        // data not null
        _OidcClientInfo["default"].validateJSON(data['oidc_client_info']);
      ...
      if (data['rotated_secret_details']) {
        // data not null
        _RotatedSecretDetailsInfo["default"].validateJSON(data['rotated_secret_details']);
      ...
      if (data['static_secret_info']) {
        // data not null
        _StaticSecretDetailsInfo["default"].validateJSON(data['static_secret_info']);
      } // validate the optional field `tokenizer_info`


      if (data['tokenizer_info']) {
        // data not null
        _TokenizerInfo["default"].validateJSON(data['tokenizer_info']);
      }
