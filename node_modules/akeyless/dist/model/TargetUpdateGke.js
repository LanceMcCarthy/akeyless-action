 ...
 * @version 5.0.1
 */
var TargetUpdateGke = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateGke</code>.
   * @alias module:model/TargetUpdateGke
   * @param name {String} Target name
   */
  function TargetUpdateGke(name) {
    _classCallCheck(this, TargetUpdateGke);
  ...
  _createClass(TargetUpdateGke, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateGke.RequiredProperties),
          _step;
