 ...
 * @version 5.0.1
 */
var GwUpdateRemoteAccessSessionLogsLogzIo = /*#__PURE__*/function () {
  /**
   ...
   */
  function GwUpdateRemoteAccessSessionLogsLogzIo() {
    _classCallCheck(this, GwUpdateRemoteAccessSessionLogsLogzIo);
  ...
  _createClass(GwUpdateRemoteAccessSessionLogsLogzIo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('logz-io-token')) {
          obj['logz-io-token'] = _ApiClient["default"].convertToType(data['logz-io-token'], 'String');
        }
...
var _default = GwUpdateRemoteAccessSessionLogsLogzIo;
