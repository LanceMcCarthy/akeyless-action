...
var GetGroupOutput = /*#__PURE__*/function () {
  ...
  _createClass(GetGroupOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('group_alias')) {
          obj['group_alias'] = _ApiClient["default"].convertToType(data['group_alias'], 'String');
        }
        ...
        if (data.hasOwnProperty('user_assignments')) {
          obj['user_assignments'] = _ApiClient["default"].convertToType(data['user_assignments'], [_AccessPermissionAssignment["default"]]);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['user_assignments']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['user_assignments']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _AccessPermissionAssignment["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
