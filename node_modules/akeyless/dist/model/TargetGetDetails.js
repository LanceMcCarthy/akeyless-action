 ...
 * @version 5.0.5
 */
var TargetGetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetGetDetails</code>.
   * @alias module:model/TargetGetDetails
   * @param name {String} Target name
   */
  function TargetGetDetails(name) {
    _classCallCheck(this, TargetGetDetails);
  ...
  _createClass(TargetGetDetails, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetGetDetails.RequiredProperties),
          _step;
