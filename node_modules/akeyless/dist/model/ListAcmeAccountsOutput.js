...
var _AcmeAccount = _interopRequireDefault(require("./AcmeAccount"));
 ...
 * @version 5.0.1
 */
var ListAcmeAccountsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAcmeAccountsOutput</code>.
   * @alias module:model/ListAcmeAccountsOutput
   */
  function ListAcmeAccountsOutput() {
    _classCallCheck(this, ListAcmeAccountsOutput);
  ...
  _createClass(ListAcmeAccountsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('accounts')) {
          obj['accounts'] = _ApiClient["default"].convertToType(data['accounts'], [_AcmeAccount["default"]]);
        }
      }
      ...
      if (data['accounts']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _AcmeAccount["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = ListAcmeAccountsOutput;
