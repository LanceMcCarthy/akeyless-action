...
var OidcClientInfo = /*#__PURE__*/function () {
  ...
  _createClass(OidcClientInfo, null, [{
    ...
    value: function validateJSON(data) {
      if (data['access_permission_assignment']) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data['access_permission_assignment']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _AccessOrGroupPermissionAssignment["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
