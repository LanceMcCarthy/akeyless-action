 ...
 * @version 5.0.8
 */
var GeminiTargetDetails = /*#__PURE__*/function () {
  /**
   ...
   */
  function GeminiTargetDetails() {
    _classCallCheck(this, GeminiTargetDetails);
  ...
  _createClass(GeminiTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gemini_url')) {
          obj['gemini_url'] = _ApiClient["default"].convertToType(data['gemini_url'], 'String');
        }
...
var _default = GeminiTargetDetails;
