 ...
 * @version 5.0.3
 */
var TargetCreateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetCreateK8s(name) {
    _classCallCheck(this, TargetCreateK8s);
  ...
  _createClass(TargetCreateK8s, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateK8s.RequiredProperties),
          _step;
