...
var CreateRole = /*#__PURE__*/function () {
  ...
  _createClass(CreateRole, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event-center-access')) {
          obj['event-center-access'] = _ApiClient["default"].convertToType(data['event-center-access'], 'String');
        }

        if (data.hasOwnProperty('event-forwarders-access')) {
          obj['event-forwarders-access'] = _ApiClient["default"].convertToType(data['event-forwarders-access'], 'String');
        }

        if (data.hasOwnProperty('event-forwarders-name')) {
          obj['event-forwarders-name'] = _ApiClient["default"].convertToType(data['event-forwarders-name'], ['String']);
        }
        ...
        if (data.hasOwnProperty('reverse-rbac-access')) {
          obj['reverse-rbac-access'] = _ApiClient["default"].convertToType(data['reverse-rbac-access'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateRole.RequiredProperties),
          _step;
