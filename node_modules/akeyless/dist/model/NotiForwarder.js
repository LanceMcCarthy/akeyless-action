...
var _WebHookNotiForwarderPublicDetails = _interopRequireDefault(require("./WebHookNotiForwarderPublicDetails"));
...
var NotiForwarder = /*#__PURE__*/function () {
  ...
  _createClass(NotiForwarder, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('include_error')) {
          obj['include_error'] = _ApiClient["default"].convertToType(data['include_error'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('override_url')) {
          obj['override_url'] = _ApiClient["default"].convertToType(data['override_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('slack_noti_forwarder_public_details')) {
          obj['slack_noti_forwarder_public_details'] = _ApiClient["default"].convertToType(data['slack_noti_forwarder_public_details'], Object);
        }

        if (data.hasOwnProperty('teams_noti_forwarder_public_details')) {
          obj['teams_noti_forwarder_public_details'] = _ApiClient["default"].convertToType(data['teams_noti_forwarder_public_details'], Object);
        }
        ...
        if (data.hasOwnProperty('webhook_noti_forwarder_public_details')) {
          obj['webhook_noti_forwarder_public_details'] = _WebHookNotiForwarderPublicDetails["default"].constructFromObject(data['webhook_noti_forwarder_public_details']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['noti_forwarder_versions']) {
        // data not null
        // ensure the json data is an array
        ...
        var _iterator = _createForOfIteratorHelper(data['noti_forwarder_versions']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _ItemVersion["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['to_emails']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['to_emails']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _EmailEntry["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['webhook_noti_forwarder_public_details']) {
        // data not null
        _WebHookNotiForwarderPublicDetails["default"].validateJSON(data['webhook_noti_forwarder_public_details']);
      }
