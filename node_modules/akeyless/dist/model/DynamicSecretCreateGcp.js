 ...
 * @version 5.0.16
 */
var DynamicSecretCreateGcp = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretCreateGcp(name) {
    _classCallCheck(this, DynamicSecretCreateGcp);
  ...
  _createClass(DynamicSecretCreateGcp, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gcp-project-id')) {
          obj['gcp-project-id'] = _ApiClient["default"].convertToType(data['gcp-project-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('role-names')) {
          obj['role-names'] = _ApiClient["default"].convertToType(data['role-names'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretCreateGcp.RequiredProperties),
          _step;
...
var _default = DynamicSecretCreateGcp;
