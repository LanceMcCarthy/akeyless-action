 ...
 * @version 5.0.6
 */
var DynamicSecretTmpCredsUpdate = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretTmpCredsUpdate(host, name, newTtlMin, tmpCredsId) {
    _classCallCheck(this, DynamicSecretTmpCredsUpdate);
  ...
  _createClass(DynamicSecretTmpCredsUpdate, null, [{
    key: "initialize",
    value: function initialize(obj, host, name, newTtlMin, tmpCredsId) {
      obj['host'] = host;
      obj['json'] = false;
      obj['name'] = name;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretTmpCredsUpdate.RequiredProperties),
          _step;
...
var _default = DynamicSecretTmpCredsUpdate;
