...
var ExportClassicKey = /*#__PURE__*/function () {
  ...
  _createClass(ExportClassicKey, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('wrapping-key-name')) {
          obj['wrapping-key-name'] = _ApiClient["default"].convertToType(data['wrapping-key-name'], 'String');
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ExportClassicKey.RequiredProperties),
          _step;
