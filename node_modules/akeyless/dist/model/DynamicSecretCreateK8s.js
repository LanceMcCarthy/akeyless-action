 ...
 * @version 5.0.14
 */
var DynamicSecretCreateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretCreateK8s(name) {
    _classCallCheck(this, DynamicSecretCreateK8s);
  ...
  _createClass(DynamicSecretCreateK8s, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretCreateK8s.RequiredProperties),
          _step;
...
var _default = DynamicSecretCreateK8s;
