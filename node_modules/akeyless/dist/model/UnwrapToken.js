...
var UnwrapToken = /*#__PURE__*/function () {
  ...
  _createClass(UnwrapToken, null, [{
    key: "initialize",
    value: function initialize(obj, sharedToken) {
      obj['json'] = false;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shared-token')) {
          obj['shared-token'] = _ApiClient["default"].convertToType(data['shared-token'], 'String');
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UnwrapToken.RequiredProperties),
          _step;
