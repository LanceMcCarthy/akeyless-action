 ...
 * @version 5.0.16
 */
var RotatedSecretUpdateSsh = /*#__PURE__*/function () {
  /**
   ...
   */
  function RotatedSecretUpdateSsh(name, rotatorType) {
    _classCallCheck(this, RotatedSecretUpdateSsh);
  ...
  _createClass(RotatedSecretUpdateSsh, null, [{
    key: "initialize",
    value: function initialize(obj, name, rotatorType) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('public-key-remote-path')) {
          obj['public-key-remote-path'] = _ApiClient["default"].convertToType(data['public-key-remote-path'], 'String');
        }
        ...
        if (data.hasOwnProperty('secure-access-target-type')) {
          obj['secure-access-target-type'] = _ApiClient["default"].convertToType(data['secure-access-target-type'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretUpdateSsh.RequiredProperties),
          _step;
...
var _default = RotatedSecretUpdateSsh;
