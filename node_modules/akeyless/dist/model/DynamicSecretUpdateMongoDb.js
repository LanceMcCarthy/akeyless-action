 ...
 * @version 5.0.16
 */
var DynamicSecretUpdateMongoDb = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateMongoDb(name) {
    _classCallCheck(this, DynamicSecretUpdateMongoDb);
  ...
  _createClass(DynamicSecretUpdateMongoDb, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mongodb-scopes')) {
          obj['mongodb-scopes'] = _ApiClient["default"].convertToType(data['mongodb-scopes'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateMongoDb.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateMongoDb;
