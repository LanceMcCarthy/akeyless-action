 ...
 * @version 5.0.8
 */
var AliasDetailsOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AliasDetailsOutput</code>.
   * @alias module:model/AliasDetailsOutput
   */
  function AliasDetailsOutput() {
    _classCallCheck(this, AliasDetailsOutput);
  ...
  _createClass(AliasDetailsOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tenant_tag')) {
          obj['tenant_tag'] = _ApiClient["default"].convertToType(data['tenant_tag'], 'String');
        }
      }
...
var _default = AliasDetailsOutput;
