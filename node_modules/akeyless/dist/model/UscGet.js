...
var UscGet = /*#__PURE__*/function () {
   ...
   */
  function UscGet(secretId, uscName) {
    _classCallCheck(this, UscGet);
  ...
  _createClass(UscGet, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('version-id')) {
          obj['version-id'] = _ApiClient["default"].convertToType(data['version-id'], 'String');
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UscGet.RequiredProperties),
          _step;
