 ...
 * @version 5.0.14
 */
var KerberosConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KerberosConfigPart</code>.
   * @alias module:model/KerberosConfigPart
   */
  function KerberosConfigPart() {
    _classCallCheck(this, KerberosConfigPart);
  ...
  _createClass(KerberosConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('kerberos_access_id')) {
          obj['kerberos_access_id'] = _ApiClient["default"].convertToType(data['kerberos_access_id'], 'String');
        }

        if (data.hasOwnProperty('kerberos_keytab')) {
          obj['kerberos_keytab'] = _ApiClient["default"].convertToType(data['kerberos_keytab'], 'String');
        }

        if (data.hasOwnProperty('kerberos_krb_5_conf')) {
          obj['kerberos_krb_5_conf'] = _ApiClient["default"].convertToType(data['kerberos_krb_5_conf'], 'String');
        }

        if (data.hasOwnProperty('kerberos_private_key')) {
          obj['kerberos_private_key'] = _ApiClient["default"].convertToType(data['kerberos_private_key'], 'String');
        }
...
var _default = KerberosConfigPart;
