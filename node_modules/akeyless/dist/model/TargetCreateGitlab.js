 ...
 * @version 5.0.5
 */
var TargetCreateGitlab = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateGitlab</code>.
   * @alias module:model/TargetCreateGitlab
   * @param name {String} Target name
   */
  function TargetCreateGitlab(name) {
    _classCallCheck(this, TargetCreateGitlab);
  ...
  _createClass(TargetCreateGitlab, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateGitlab.RequiredProperties),
          _step;
...
var _default = TargetCreateGitlab;
