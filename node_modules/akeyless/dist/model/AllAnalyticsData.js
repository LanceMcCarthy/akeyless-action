...
var _CertificateAnalyticAggregation = _interopRequireDefault(require("./CertificateAnalyticAggregation"));

var _ClientsUsageReport = _interopRequireDefault(require("./ClientsUsageReport"));

var _UsageReportSummary = _interopRequireDefault(require("./UsageReportSummary"));
 ...
 * @version 5.0.5
 */
var AllAnalyticsData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AllAnalyticsData</code>.
   * @alias module:model/AllAnalyticsData
   */
  function AllAnalyticsData() {
    _classCallCheck(this, AllAnalyticsData);
  ...
  _createClass(AllAnalyticsData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('analytics_data')) {
          obj['analytics_data'] = _ApiClient["default"].convertToType(data['analytics_data'], {
            'String': [['String']]
          });
        }

        if (data.hasOwnProperty('certificates_expiry_data')) {
          obj['certificates_expiry_data'] = _CertificateAnalyticAggregation["default"].constructFromObject(data['certificates_expiry_data']);
        }

        if (data.hasOwnProperty('clients_usage_reports')) {
          obj['clients_usage_reports'] = _ApiClient["default"].convertToType(data['clients_usage_reports'], {
            'String': _ClientsUsageReport["default"]
          });
        }

        if (data.hasOwnProperty('date_updated')) {
          obj['date_updated'] = _ApiClient["default"].convertToType(data['date_updated'], 'Number');
        }

        if (data.hasOwnProperty('usage_reports')) {
          obj['usage_reports'] = _ApiClient["default"].convertToType(data['usage_reports'], {
            'String': _UsageReportSummary["default"]
          });
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['certificates_expiry_data']) {
        // data not null
        _CertificateAnalyticAggregation["default"].validateJSON(data['certificates_expiry_data']);
      }
