 ...
 * @version 5.0.6
 */
var TargetUpdateHashiVault = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateHashiVault</code>.
   * @alias module:model/TargetUpdateHashiVault
   * @param name {String} Target name
   */
  function TargetUpdateHashiVault(name) {
    _classCallCheck(this, TargetUpdateHashiVault);
  ...
  _createClass(TargetUpdateHashiVault, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateHashiVault.RequiredProperties),
          _step;
...
var _default = TargetUpdateHashiVault;
