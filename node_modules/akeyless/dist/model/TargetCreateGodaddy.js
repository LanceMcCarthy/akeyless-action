 ...
 * @version 5.0.1
 */
var TargetCreateGodaddy = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetCreateGodaddy(apiKey, imapFqdn, imapPassword, imapUsername, name, secret) {
    _classCallCheck(this, TargetCreateGodaddy);
  ...
  _createClass(TargetCreateGodaddy, null, [{
    key: "initialize",
    value: function initialize(obj, apiKey, imapFqdn, imapPassword, imapUsername, name, secret) {
      obj['api-key'] = apiKey;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateGodaddy.RequiredProperties),
          _step;
...
var _default = TargetCreateGodaddy;
