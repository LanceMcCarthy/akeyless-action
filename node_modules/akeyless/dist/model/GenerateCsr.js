...
var GenerateCsr = /*#__PURE__*/function () {
   ...
   */
  function GenerateCsr(commonName, keyType, name) {
  ...
  _createClass(GenerateCsr, null, [{
    key: "initialize",
    value: function initialize(obj, commonName, keyType, name) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('export-private-key')) {
          obj['export-private-key'] = _ApiClient["default"].convertToType(data['export-private-key'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('hash-algorithm')) {
          obj['hash-algorithm'] = _ApiClient["default"].convertToType(data['hash-algorithm'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GenerateCsr.RequiredProperties),
          _step;
