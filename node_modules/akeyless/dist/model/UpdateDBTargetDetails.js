...
var UpdateDBTargetDetails = /*#__PURE__*/function () {
  ...
  _createClass(UpdateDBTargetDetails, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mongo-db-name')) {
          obj['mongo-db-name'] = _ApiClient["default"].convertToType(data['mongo-db-name'], 'String');
        }

        if (data.hasOwnProperty('mongo-uri')) {
          obj['mongo-uri'] = _ApiClient["default"].convertToType(data['mongo-uri'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateDBTargetDetails.RequiredProperties),
          _step;
