...
var UpdateRole = /*#__PURE__*/function () {
  ...
  _createClass(UpdateRole, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('event-forwarder-access')) {
          obj['event-forwarder-access'] = _ApiClient["default"].convertToType(data['event-forwarder-access'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateRole.RequiredProperties),
          _step;
