    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('azure-ad-object-id')) {
          obj['azure-ad-object-id'] = _ApiClient["default"].convertToType(data['azure-ad-object-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('default-location-prefix')) {
          obj['default-location-prefix'] = _ApiClient["default"].convertToType(data['default-location-prefix'], 'String');
        }
