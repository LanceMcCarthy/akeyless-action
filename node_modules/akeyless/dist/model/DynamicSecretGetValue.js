 ...
 * @version 5.0.1
 */
var DynamicSecretGetValue = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DynamicSecretGetValue</code>.
   * @alias module:model/DynamicSecretGetValue
   * @param name {String} Dynamic secret name
   */
  function DynamicSecretGetValue(name) {
    _classCallCheck(this, DynamicSecretGetValue);
  ...
  _createClass(DynamicSecretGetValue, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretGetValue.RequiredProperties),
          _step;
...
var _default = DynamicSecretGetValue;
