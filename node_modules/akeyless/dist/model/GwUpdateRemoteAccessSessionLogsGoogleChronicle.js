 ...
 * @version 5.0.8
 */
var GwUpdateRemoteAccessSessionLogsGoogleChronicle = /*#__PURE__*/function () {
  /**
   ...
   */
  function GwUpdateRemoteAccessSessionLogsGoogleChronicle() {
    _classCallCheck(this, GwUpdateRemoteAccessSessionLogsGoogleChronicle);
  ...
  _createClass(GwUpdateRemoteAccessSessionLogsGoogleChronicle, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('customer-id')) {
          obj['customer-id'] = _ApiClient["default"].convertToType(data['customer-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('log-type')) {
          obj['log-type'] = _ApiClient["default"].convertToType(data['log-type'], 'String');
        }
...
var _default = GwUpdateRemoteAccessSessionLogsGoogleChronicle;
