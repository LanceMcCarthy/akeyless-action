 ...
 * @version 5.0.3
 */
var TargetCreateGcp = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateGcp</code>.
   * @alias module:model/TargetCreateGcp
   * @param name {String} Target name
   */
  function TargetCreateGcp(name) {
    _classCallCheck(this, TargetCreateGcp);
  ...
  _createClass(TargetCreateGcp, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateGcp.RequiredProperties),
          _step;
