...
var ConfigChange = /*#__PURE__*/function () {
  ...
  _createClass(ConfigChange, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['config_hash']) {
        // data not null
        _ConfigHash["default"].validateJSON(data['config_hash']);
      } // validate the optional field `last_change`


      if (data['last_change']) {
        // data not null
        _LastConfigChange["default"].validateJSON(data['last_change']);
      } // validate the optional field `last_status`


      if (data['last_status']) {
        // data not null
        _LastStatusInfo["default"].validateJSON(data['last_status']);
      } // validate the optional field `required_activity`


      if (data['required_activity']) {
        // data not null
        _RequiredActivity["default"].validateJSON(data['required_activity']);
      }
