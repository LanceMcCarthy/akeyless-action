...
var GeneralConfigPart = /*#__PURE__*/function () {
  ...
  _createClass(GeneralConfigPart, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('hvp_route_version')) {
          obj['hvp_route_version'] = _ApiClient["default"].convertToType(data['hvp_route_version'], 'Number');
        }

        if (data.hasOwnProperty('notify_on_status_change')) {
          obj['notify_on_status_change'] = _ApiClient["default"].convertToType(data['notify_on_status_change'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('tls_cert_common_name')) {
          obj['tls_cert_common_name'] = _ApiClient["default"].convertToType(data['tls_cert_common_name'], 'String');
        }

        if (data.hasOwnProperty('tls_cert_expiration_date')) {
          obj['tls_cert_expiration_date'] = _ApiClient["default"].convertToType(data['tls_cert_expiration_date'], 'Date');
        }

        if (data.hasOwnProperty('tls_cert_expiration_events')) {
          obj['tls_cert_expiration_events'] = _ApiClient["default"].convertToType(data['tls_cert_expiration_events'], [_CertificateExpirationEvent["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['tls_cert_expiration_events']) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data['tls_cert_expiration_events']),
            _step;
