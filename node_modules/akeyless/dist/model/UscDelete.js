 ...
 * @version 5.0.20
 */
var UscDelete = /*#__PURE__*/function () {
  /**
   ...
   */
  function UscDelete(secretId, uscName) {
    _classCallCheck(this, UscDelete);
  ...
  _createClass(UscDelete, null, [{
    key: "initialize",
    value: function initialize(obj, secretId, uscName) {
      obj['json'] = false;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('force-delete')) {
          obj['force-delete'] = _ApiClient["default"].convertToType(data['force-delete'], 'Boolean');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UscDelete.RequiredProperties),
          _step;
