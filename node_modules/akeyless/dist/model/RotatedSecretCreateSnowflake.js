 ...
 * @version 5.0.14
 */
var RotatedSecretCreateSnowflake = /*#__PURE__*/function () {
  /**
   ...
   */
  function RotatedSecretCreateSnowflake(name, rotatorType, targetName) {
    _classCallCheck(this, RotatedSecretCreateSnowflake);
  ...
  _createClass(RotatedSecretCreateSnowflake, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('private-key-file-name')) {
          obj['private-key-file-name'] = _ApiClient["default"].convertToType(data['private-key-file-name'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretCreateSnowflake.RequiredProperties),
          _step;
...
var _default = RotatedSecretCreateSnowflake;
