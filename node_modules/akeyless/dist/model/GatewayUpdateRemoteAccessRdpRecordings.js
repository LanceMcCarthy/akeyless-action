 ...
 * @version 5.0.6
 */
var GatewayUpdateRemoteAccessRdpRecordings = /*#__PURE__*/function () {
  /**
   ...
   */
  function GatewayUpdateRemoteAccessRdpRecordings() {
    _classCallCheck(this, GatewayUpdateRemoteAccessRdpRecordings);
  ...
  _createClass(GatewayUpdateRemoteAccessRdpRecordings, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('aws-storage-access-key-id')) {
          obj['aws-storage-access-key-id'] = _ApiClient["default"].convertToType(data['aws-storage-access-key-id'], 'String');
        }

        if (data.hasOwnProperty('aws-storage-bucket-name')) {
          obj['aws-storage-bucket-name'] = _ApiClient["default"].convertToType(data['aws-storage-bucket-name'], 'String');
        }

        if (data.hasOwnProperty('aws-storage-bucket-prefix')) {
          obj['aws-storage-bucket-prefix'] = _ApiClient["default"].convertToType(data['aws-storage-bucket-prefix'], 'String');
        }

        if (data.hasOwnProperty('aws-storage-region')) {
          obj['aws-storage-region'] = _ApiClient["default"].convertToType(data['aws-storage-region'], 'String');
        }

        if (data.hasOwnProperty('aws-storage-secret-access-key')) {
          obj['aws-storage-secret-access-key'] = _ApiClient["default"].convertToType(data['aws-storage-secret-access-key'], 'String');
        }

        if (data.hasOwnProperty('azure-storage-account-name')) {
          obj['azure-storage-account-name'] = _ApiClient["default"].convertToType(data['azure-storage-account-name'], 'String');
        }

        if (data.hasOwnProperty('azure-storage-client-id')) {
          obj['azure-storage-client-id'] = _ApiClient["default"].convertToType(data['azure-storage-client-id'], 'String');
        }

        if (data.hasOwnProperty('azure-storage-client-secret')) {
          obj['azure-storage-client-secret'] = _ApiClient["default"].convertToType(data['azure-storage-client-secret'], 'String');
        }

        if (data.hasOwnProperty('azure-storage-container-name')) {
          obj['azure-storage-container-name'] = _ApiClient["default"].convertToType(data['azure-storage-container-name'], 'String');
        }

        if (data.hasOwnProperty('azure-storage-tenant-id')) {
          obj['azure-storage-tenant-id'] = _ApiClient["default"].convertToType(data['azure-storage-tenant-id'], 'String');
        }
        ...
        if (data.hasOwnProperty('rdp-session-recording')) {
          obj['rdp-session-recording'] = _ApiClient["default"].convertToType(data['rdp-session-recording'], 'String');
        }

        if (data.hasOwnProperty('rdp-session-recording-compress')) {
          obj['rdp-session-recording-compress'] = _ApiClient["default"].convertToType(data['rdp-session-recording-compress'], 'Boolean');
        }

        if (data.hasOwnProperty('rdp-session-recording-encryption-key')) {
          obj['rdp-session-recording-encryption-key'] = _ApiClient["default"].convertToType(data['rdp-session-recording-encryption-key'], 'String');
        }

        if (data.hasOwnProperty('rdp-session-recording-quality')) {
          obj['rdp-session-recording-quality'] = _ApiClient["default"].convertToType(data['rdp-session-recording-quality'], 'String');
        }

        if (data.hasOwnProperty('rdp-session-storage')) {
          obj['rdp-session-storage'] = _ApiClient["default"].convertToType(data['rdp-session-storage'], 'String');
        }
...
var _default = GatewayUpdateRemoteAccessRdpRecordings;
