...
var UpdateRDPTargetDetails = /*#__PURE__*/function () {
  ...
  _createClass(UpdateRDPTargetDetails, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('host-name')) {
          obj['host-name'] = _ApiClient["default"].convertToType(data['host-name'], 'String');
        }

        if (data.hasOwnProperty('host-port')) {
          obj['host-port'] = _ApiClient["default"].convertToType(data['host-port'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UpdateRDPTargetDetails.RequiredProperties),
          _step;
