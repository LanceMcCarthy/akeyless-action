 ...
 * @version 5.0.8
 */
var TargetUpdateGcp = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetUpdateGcp</code>.
   * @alias module:model/TargetUpdateGcp
   * @param name {String} Target name
   */
  function TargetUpdateGcp(name) {
    _classCallCheck(this, TargetUpdateGcp);
  ...
  _createClass(TargetUpdateGcp, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateGcp.RequiredProperties),
          _step;
