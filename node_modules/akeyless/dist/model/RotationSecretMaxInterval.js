 ...
 * @version 4.2.1
 */
var RotationSecretMaxInterval = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RotationSecretMaxInterval</code>.
   * @alias module:model/RotationSecretMaxInterval
   */
  function RotationSecretMaxInterval() {
    _classCallCheck(this, RotationSecretMaxInterval);
  ...
  _createClass(RotationSecretMaxInterval, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('max_interval_by_days')) {
          obj['max_interval_by_days'] = _ApiClient["default"].convertToType(data['max_interval_by_days'], 'Number');
        }
      }
...
var _default = RotationSecretMaxInterval;
