    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cache_encryption_key')) {
          obj['cache_encryption_key'] = _ApiClient["default"].convertToType(data['cache_encryption_key'], 'String');
        }
        ...
        if (data.hasOwnProperty('new_proactive_cache_enable')) {
          obj['new_proactive_cache_enable'] = _ApiClient["default"].convertToType(data['new_proactive_cache_enable'], 'Boolean');
        }
