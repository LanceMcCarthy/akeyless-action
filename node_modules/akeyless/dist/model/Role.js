...
var Role = /*#__PURE__*/function () {
  ...
  _createClass(Role, null, [{
    ...
    value: function validateJSON(data) {
      ...
      if (data['role_auth_methods_assoc']) {
        // data not null
        // ensure the json data is an array
        ...
        var _iterator = _createForOfIteratorHelper(data['role_auth_methods_assoc']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RoleAuthMethodAssociation["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
