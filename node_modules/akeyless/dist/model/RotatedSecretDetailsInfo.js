...
var _WindowsService = _interopRequireDefault(require("./WindowsService"));
  ...
  _createClass(RotatedSecretDetailsInfo, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('enable_custom_password_policy')) {
          obj['enable_custom_password_policy'] = _ApiClient["default"].convertToType(data['enable_custom_password_policy'], 'Boolean');
        }

        if (data.hasOwnProperty('grace_rotation')) {
          obj['grace_rotation'] = _ApiClient["default"].convertToType(data['grace_rotation'], 'Boolean');
        }

        if (data.hasOwnProperty('grace_rotation_hour')) {
          obj['grace_rotation_hour'] = _ApiClient["default"].convertToType(data['grace_rotation_hour'], 'Number');
        }

        if (data.hasOwnProperty('grace_rotation_interval')) {
          obj['grace_rotation_interval'] = _ApiClient["default"].convertToType(data['grace_rotation_interval'], 'Number');
        }
        ...
        if (data.hasOwnProperty('iis_apps_details')) {
          obj['iis_apps_details'] = _ApiClient["default"].convertToType(data['iis_apps_details'], [_WindowsService["default"]]);
        }
        ...
        if (data.hasOwnProperty('managed_by_akeyless')) {
          obj['managed_by_akeyless'] = _ApiClient["default"].convertToType(data['managed_by_akeyless'], 'Boolean');
        }

        if (data.hasOwnProperty('max_versions')) {
          obj['max_versions'] = _ApiClient["default"].convertToType(data['max_versions'], 'Number');
        }

        if (data.hasOwnProperty('next_auto_rotate_type')) {
          obj['next_auto_rotate_type'] = _ApiClient["default"].convertToType(data['next_auto_rotate_type'], 'String');
        }
        ...
        if (data.hasOwnProperty('public_key_remote_path')) {
          obj['public_key_remote_path'] = _ApiClient["default"].convertToType(data['public_key_remote_path'], 'String');
        }
        ...
        if (data.hasOwnProperty('services_details')) {
          obj['services_details'] = _ApiClient["default"].convertToType(data['services_details'], [_WindowsService["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['iis_apps_details']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['iis_apps_details']),
            _step;
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _WindowsService["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['services_details']) {
        ...
        var _iterator2 = _createForOfIteratorHelper(data['services_details']),
            _step2;
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _WindowsService["default"].validateJSON(_item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
