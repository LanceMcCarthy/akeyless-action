 ...
 * @version 5.0.20
 */
var UscCreate = /*#__PURE__*/function () {
  /**
   ...
   */
  function UscCreate(secretName, uscName, value) {
    _classCallCheck(this, UscCreate);
  ...
  _createClass(UscCreate, null, [{
    key: "initialize",
    value: function initialize(obj, secretName, uscName, value) {
      obj['json'] = false;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('object-type')) {
          obj['object-type'] = _ApiClient["default"].convertToType(data['object-type'], 'String');
        }

        if (data.hasOwnProperty('pfx-password')) {
          obj['pfx-password'] = _ApiClient["default"].convertToType(data['pfx-password'], 'String');
        }
        ...
        if (data.hasOwnProperty('usc-encryption-key')) {
          obj['usc-encryption-key'] = _ApiClient["default"].convertToType(data['usc-encryption-key'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UscCreate.RequiredProperties),
          _step;
