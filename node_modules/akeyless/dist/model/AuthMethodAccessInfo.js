...
var _KerberosAccessRules = _interopRequireDefault(require("./KerberosAccessRules"));
...
var _OCIAccessRules = _interopRequireDefault(require("./OCIAccessRules"));
...
var AuthMethodAccessInfo = /*#__PURE__*/function () {
  ...
  _createClass(AuthMethodAccessInfo, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_client_type')) {
          obj['allowed_client_type'] = _ApiClient["default"].convertToType(data['allowed_client_type'], ['String']);
        }
        ...
        if (data.hasOwnProperty('audit_logs_claims')) {
          obj['audit_logs_claims'] = _ApiClient["default"].convertToType(data['audit_logs_claims'], ['String']);
        }
        ...
        if (data.hasOwnProperty('kerberos_access_rules')) {
          obj['kerberos_access_rules'] = _KerberosAccessRules["default"].constructFromObject(data['kerberos_access_rules']);
        }
        ...
        if (data.hasOwnProperty('oci_access_rules')) {
          obj['oci_access_rules'] = _OCIAccessRules["default"].constructFromObject(data['oci_access_rules']);
        }
        ...
        if (data.hasOwnProperty('product_types')) {
          obj['product_types'] = _ApiClient["default"].convertToType(data['product_types'], ['String']);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['api_key_access_rules']) {
        // data not null
        _APIKeyAccessRules["default"].validateJSON(data['api_key_access_rules']);
      } // ensure the json data is an array
      ...
      if (data['aws_iam_access_rules']) {
        // data not null
        _AWSIAMAccessRules["default"].validateJSON(data['aws_iam_access_rules']);
      } // validate the optional field `azure_ad_access_rules`


      if (data['azure_ad_access_rules']) {
        // data not null
        _AzureADAccessRules["default"].validateJSON(data['azure_ad_access_rules']);
      } // validate the optional field `cert_access_rules`


      if (data['cert_access_rules']) {
        // data not null
        _CertAccessRules["default"].validateJSON(data['cert_access_rules']);
      } // ensure the json data is a string
      ...
      if (data['email_pass_access_rules']) {
        // data not null
        _EmailPassAccessRules["default"].validateJSON(data['email_pass_access_rules']);
      } // validate the optional field `gcp_access_rules`


      if (data['gcp_access_rules']) {
        // data not null
        _GCPAccessRules["default"].validateJSON(data['gcp_access_rules']);
      } // ensure the json data is a string
      ...
      if (data['huawei_access_rules']) {
        // data not null
        _HuaweiAccessRules["default"].validateJSON(data['huawei_access_rules']);
      } // validate the optional field `k8s_access_rules`


      if (data['k8s_access_rules']) {
        // data not null
        _KubernetesAccessRules["default"].validateJSON(data['k8s_access_rules']);
      } // validate the optional field `kerberos_access_rules`


      if (data['kerberos_access_rules']) {
        // data not null
        _KerberosAccessRules["default"].validateJSON(data['kerberos_access_rules']);
      } // validate the optional field `ldap_access_rules`


      if (data['ldap_access_rules']) {
        // data not null
        _LDAPAccessRules["default"].validateJSON(data['ldap_access_rules']);
      } // validate the optional field `oauth2_access_rules`


      if (data['oauth2_access_rules']) {
        // data not null
        _OAuth2AccessRules["default"].validateJSON(data['oauth2_access_rules']);
      } // validate the optional field `oci_access_rules`


      if (data['oci_access_rules']) {
        // data not null
        _OCIAccessRules["default"].validateJSON(data['oci_access_rules']);
      } // validate the optional field `oidc_access_rules`


      if (data['oidc_access_rules']) {
        // data not null
        _OIDCAccessRules["default"].validateJSON(data['oidc_access_rules']);
      } // ensure the json data is an array
      ...
      if (data['saml_access_rules']) {
        // data not null
        _SAMLAccessRules["default"].validateJSON(data['saml_access_rules']);
      } // ensure the json data is an array
      ...
      if (data['universal_identity_access_rules']) {
        // data not null
        _UniversalIdentityAccessRules["default"].validateJSON(data['universal_identity_access_rules']);
      }
