...
var _WebBastionGuacamole = _interopRequireDefault(require("./WebBastionGuacamole"));

var _WebBastionRdpRecord = _interopRequireDefault(require("./WebBastionRdpRecord"));
 ...
 * @version 5.0.3
 */
var WebBastionConf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WebBastionConf</code>.
   * @alias module:model/WebBastionConf
   */
  function WebBastionConf() {
    _classCallCheck(this, WebBastionConf);
  ...
  _createClass(WebBastionConf, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('guacamole')) {
          obj['guacamole'] = _WebBastionGuacamole["default"].constructFromObject(data['guacamole']);
        }

        if (data.hasOwnProperty('rdp_record')) {
          obj['rdp_record'] = _WebBastionRdpRecord["default"].constructFromObject(data['rdp_record']);
        }
      }
    ...
    value: function validateJSON(data) {
      ...
      if (data['guacamole']) {
        // data not null
        _WebBastionGuacamole["default"].validateJSON(data['guacamole']);
      } // validate the optional field `rdp_record`


      if (data['rdp_record']) {
        // data not null
        _WebBastionRdpRecord["default"].validateJSON(data['rdp_record']);
      }
