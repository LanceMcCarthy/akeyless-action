 ...
 * @version 5.0.14
 */
var DynamicSecretCreateGithub = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretCreateGithub(name) {
    _classCallCheck(this, DynamicSecretCreateGithub);
  ...
  _createClass(DynamicSecretCreateGithub, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('token-ttl')) {
          obj['token-ttl'] = _ApiClient["default"].convertToType(data['token-ttl'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretCreateGithub.RequiredProperties),
          _step;
...
var _default = DynamicSecretCreateGithub;
