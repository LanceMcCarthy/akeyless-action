 ...
 * @version 5.0.6
 */
var CertificateAnalyticAggregation = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CertificateAnalyticAggregation</code>.
   * @alias module:model/CertificateAnalyticAggregation
   */
  function CertificateAnalyticAggregation() {
    _classCallCheck(this, CertificateAnalyticAggregation);
  ...
  _createClass(CertificateAnalyticAggregation, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ca_counts')) {
          obj['ca_counts'] = _ApiClient["default"].convertToType(data['ca_counts'], {
            'String': 'Number'
          });
        }

        if (data.hasOwnProperty('risk_counts')) {
          obj['risk_counts'] = _ApiClient["default"].convertToType(data['risk_counts'], {
            'String': 'Number'
          });
        }
      }
...
var _default = CertificateAnalyticAggregation;
