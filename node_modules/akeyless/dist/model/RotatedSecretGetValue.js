 ...
 * @version 5.0.1
 */
var RotatedSecretGetValue = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RotatedSecretGetValue</code>.
   * @alias module:model/RotatedSecretGetValue
   * @param name {String} Secret name
   */
  function RotatedSecretGetValue(name) {
    _classCallCheck(this, RotatedSecretGetValue);
  ...
  _createClass(RotatedSecretGetValue, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(RotatedSecretGetValue.RequiredProperties),
          _step;
...
var _default = RotatedSecretGetValue;
