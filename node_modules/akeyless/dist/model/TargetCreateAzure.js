 ...
 * @version 5.0.3
 */
var TargetCreateAzure = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetCreateAzure</code>.
   * @alias module:model/TargetCreateAzure
   * @param name {String} Target name
   */
  function TargetCreateAzure(name) {
    _classCallCheck(this, TargetCreateAzure);
  ...
  _createClass(TargetCreateAzure, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetCreateAzure.RequiredProperties),
          _step;
...
var _default = TargetCreateAzure;
