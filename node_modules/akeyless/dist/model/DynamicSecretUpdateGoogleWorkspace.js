 ...
 * @version 5.0.16
 */
var DynamicSecretUpdateGoogleWorkspace = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateGoogleWorkspace(accessMode, adminEmail, name) {
    _classCallCheck(this, DynamicSecretUpdateGoogleWorkspace);
  ...
  _createClass(DynamicSecretUpdateGoogleWorkspace, null, [{
    key: "initialize",
    value: function initialize(obj, accessMode, adminEmail, name) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('group-email')) {
          obj['group-email'] = _ApiClient["default"].convertToType(data['group-email'], 'String');
        }

        if (data.hasOwnProperty('group-role')) {
          obj['group-role'] = _ApiClient["default"].convertToType(data['group-role'], 'String');
        }

        if (data.hasOwnProperty('item-custom-fields')) {
          obj['item-custom-fields'] = _ApiClient["default"].convertToType(data['item-custom-fields'], {
            'String': 'String'
          });
        }
        ...
        if (data.hasOwnProperty('role-scope')) {
          obj['role-scope'] = _ApiClient["default"].convertToType(data['role-scope'], 'String');
        }

        if (data.hasOwnProperty('secure-access-delay')) {
          obj['secure-access-delay'] = _ApiClient["default"].convertToType(data['secure-access-delay'], 'Number');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateGoogleWorkspace.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateGoogleWorkspace;
