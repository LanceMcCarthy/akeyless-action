 ...
 * @version 5.0.5
 */
var TargetUpdateK8s = /*#__PURE__*/function () {
  /**
   ...
   */
  function TargetUpdateK8s(name) {
    _classCallCheck(this, TargetUpdateK8s);
  ...
  _createClass(TargetUpdateK8s, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TargetUpdateK8s.RequiredProperties),
          _step;
