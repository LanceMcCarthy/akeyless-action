 ...
 * @version 5.0.20
 */
var DynamicSecretUpdateMsSql = /*#__PURE__*/function () {
  /**
   ...
   */
  function DynamicSecretUpdateMsSql(name) {
    _classCallCheck(this, DynamicSecretUpdateMsSql);
  ...
  _createClass(DynamicSecretUpdateMsSql, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mssql-allowed-db-names')) {
          obj['mssql-allowed-db-names'] = _ApiClient["default"].convertToType(data['mssql-allowed-db-names'], 'String');
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DynamicSecretUpdateMsSql.RequiredProperties),
          _step;
...
var _default = DynamicSecretUpdateMsSql;
